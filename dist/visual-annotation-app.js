...
.icon-transitions-module__sending___uaLN- {
  ...
  `,document.head.appendChild(e),N.pausedAnimations=[];try{document.getAnimations().forEach(e=>{if(e.playState!==`running`)return;let t=e.effect?.target;be(t)||(e.pause(),N.pausedAnimations.push(e))})}catch{}document.querySelectorAll(`video`).forEach(e=>{e.paused||(e.dataset.wasPaused=`false`,e.pause())})}function Se(){if(typeof document>`u`||!N.frozen)return;N.frozen=!1;let e=N.frozenTimeoutQueue;N.frozenTimeoutQueue=[];for(let t of e)N.origSetTimeout(()=>{if(N.frozen){N.frozenTimeoutQueue.push(t);return}try{t()}catch(e){console.warn(`[agentation] Error replaying queued timeout:`,e)}},0);let t=N.frozenRAFQueue;N.frozenRAFQueue=[];for(let e of t)N.origRAF(t=>{if(N.frozen){N.frozenRAFQueue.push(e);return}e(t)});for(let e of N.pausedAnimations)try{e.play()}catch(e){console.warn(`[agentation] Error resuming animation:`,e)}N.pausedAnimations=[],document.getElementById(he)?.remove(),document.querySelectorAll(`video`).forEach(e=>{e.dataset.wasPaused===`false`&&(e.play().catch(()=>{}),delete e.dataset.wasPaused)})}function Ce(e){if(!e)return;let t=e=>e.stopImmediatePropagation();document.addEventListener(`focusin`,t,!0),document.addEventListener(`focusout`,t,!0);try{e.focus()}finally{document.removeEventListener(`focusin`,t,!0),document.removeEventListener(`focusout`,t,!0)}}var we=(0,b.forwardRef)(function({element:e,timestamp:t,selectedText:n,placeholder:r=`What should change?`,initialValue:i=``,submitLabel:a=`Add`,onSubmit:o,onCancel:s,onDelete:c,style:l,accentColor:u=`#3c82f7`,isExiting:d=!1,lightMode:f=!1,computedStyles:p},m){let[h,g]=(0,b.useState)(i),[_,v]=(0,b.useState)(!1),[y,x]=(0,b.useState)(`initial`),[C,w]=(0,b.useState)(!1),[ee,te]=(0,b.useState)(!1),E=(0,b.useRef)(null),ne=(0,b.useRef)(null),re=(0,b.useRef)(null),ie=(0,b.useRef)(null);(0,b.useEffect)(()=>{d&&y!==`exit`&&x(`exit`)},[d,y]),(0,b.useEffect)(()=>{P(()=>{x(`enter`)},0);let e=P(()=>{x(`entered`)},200),t=P(()=>{let e=E.current;e&&(Ce(e),e.selectionStart=e.selectionEnd=e.value.length,e.scrollTop=e.scrollHeight)},50);return()=>{clearTimeout(e),clearTimeout(t),re.current&&clearTimeout(re.current),ie.current&&clearTimeout(ie.current)}},[]);let ae=(0,b.useCallback)(()=>{ie.current&&clearTimeout(ie.current),v(!0),ie.current=P(()=>{v(!1),Ce(E.current)},250)},[]);(0,b.useImperativeHandle)(m,()=>({shake:ae}),[ae]);let oe=(0,b.useCallback)(()=>{x(`exit`),re.current=P(()=>{s()},150)},[s]),se=(0,b.useCallback)(()=>{h.trim()&&o(h.trim())},[h,o]),ce=(0,b.useCallback)(e=>{e.stopPropagation(),!e.nativeEvent.isComposing&&(e.key===`Enter`&&!e.shiftKey&&(e.preventDefault(),se()),e.key===`Escape`&&oe())},[se,oe]);return(0,S.jsxs)(`div`,{ref:ne,className:[T.popup,f?T.light:``,y===`enter`?T.enter:``,y===`entered`?T.entered:``,y===`exit`?T.exit:``,_?T.shake:``].filter(Boolean).join(` `),"data-annotation-popup":!0,style:l,onClick:e=>e.stopPropagation(),children:[(0,S.jsxs)(`div`,{className:T.header,children:[p&&Object.keys(p).length>0?(0,S.jsxs)(`button`,{className:T.headerToggle,onClick:()=>{let e=ee;te(!ee),e&&P(()=>Ce(E.current),0)},type:`button`,children:[(0,S.jsx)(`svg`,{className:`${T.chevron} ${ee?T.expanded:``}`,width:`14`,height:`14`,viewBox:`0 0 14 14`,fill:`none`,xmlns:`http://www.w3.org/2000/svg`,children:(0,S.jsx)(`path`,{d:`M5.5 10.25L9 7.25L5.75 4`,stroke:`currentColor`,strokeWidth:`1.5`,strokeLinecap:`round`,strokeLinejoin:`round`})}),(0,S.jsx)(`span`,{className:T.element,children:e})]}):(0,S.jsx)(`span`,{className:T.element,children:e}),t&&(0,S.jsx)(`span`,{className:T.timestamp,children:t})]}),p&&Object.keys(p).length>0&&(0,S.jsx)(`div`,{className:`${T.stylesWrapper} ${ee?T.expanded:``}`,children:(0,S.jsx)(`div`,{className:T.stylesInner,children:(0,S.jsx)(`div`,{className:T.stylesBlock,children:Object.entries(p).map(([e,t])=>(0,S.jsxs)(`div`,{className:T.styleLine,children:[(0,S.jsx)(`span`,{className:T.styleProperty,children:e.replace(/([A-Z])/g,`-$1`).toLowerCase()}),`: `,(0,S.jsx)(`span`,{className:T.styleValue,children:t}),`;`]},e))})})}),n&&(0,S.jsxs)(`div`,{className:T.quote,children:[`“`,n.slice(0,80),n.length>80?`...`:``,`”`]}),(0,S.jsx)(`textarea`,{ref:E,className:T.textarea,style:{borderColor:C?u:void 0},placeholder:r,value:h,onChange:e=>g(e.target.value),onFocus:()=>w(!0),onBlur:()=>w(!1),rows:2,onKeyDown:ce}),(0,S.jsxs)(`div`,{className:T.actions,children:[c&&(0,S.jsx)(`div`,{className:T.deleteWrapper,children:(0,S.jsx)(`button`,{className:T.deleteButton,onClick:c,type:`button`,children:(0,S.jsx)(j,{size:22})})}),(0,S.jsx)(`button`,{className:T.cancel,onClick:oe,children:`Cancel`}),(0,S.jsx)(`button`,{className:T.submit,style:{backgroundColor:u,opacity:h.trim()?1:.4},onClick:se,disabled:!h.trim(),children:a})]})]})}),Te=({content:e,children:t,...n})=>{let[r,i]=(0,b.useState)(!1),[a,o]=(0,b.useState)(!1),[s,c]=(0,b.useState)({top:0,right:0}),l=(0,b.useRef)(null),u=(0,b.useRef)(null),d=(0,b.useRef)(null),f=()=>{if(l.current){let e=l.current.getBoundingClientRect();c({top:e.top+e.height/2,right:window.innerWidth-e.left+8})}};return(0,b.useEffect)(()=>()=>{u.current&&clearTimeout(u.current),d.current&&clearTimeout(d.current)},[]),(0,S.jsxs)(S.Fragment,{children:[(0,S.jsx)(`span`,{ref:l,onMouseEnter:()=>{o(!0),d.current&&=(clearTimeout(d.current),null),f(),u.current=P(()=>{i(!0)},500)},onMouseLeave:()=>{u.current&&=(clearTimeout(u.current),null),i(!1),d.current=P(()=>{o(!1)},150)},...n,children:t}),a&&(0,x.createPortal)((0,S.jsx)(`div`,{"data-feedback-toolbar":!0,style:{position:`fixed`,top:s.top,right:s.right,transform:`translateY(-50%)`,padding:`6px 10px`,background:`#383838`,color:`rgba(255, 255, 255, 0.7)`,fontSize:`11px`,fontWeight:400,lineHeight:`14px`,borderRadius:`10px`,width:`180px`,textAlign:`left`,zIndex:100020,pointerEvents:`none`,boxShadow:`0px 1px 8px rgba(0, 0, 0, 0.28)`,opacity:+!!r,transition:`opacity 0.15s ease`},children:e}),document.body)]})},Ee=`.styles-module__tooltip___mcXL2 {
  display: flex;
  justify-content: center;
  align-items: center;
  cursor: help;
...
[data-agentation-theme=light] .styles-module__tooltipIcon___Nq2nD {
  color: #000;
}`,De={tooltip:`styles-module__tooltip___mcXL2`,tooltipIcon:`styles-module__tooltipIcon___Nq2nD`};if(typeof document<`u`){let e=document.getElementById(`feedback-tool-styles-help-tooltip-styles`);e||(e=document.createElement(`style`),e.id=`feedback-tool-styles-help-tooltip-styles`,document.head.appendChild(e)),e.textContent=Ee}var Oe=De,ke=({content:e})=>(0,S.jsx)(Te,{className:Oe.tooltip,content:e,children:(0,S.jsx)(ie,{className:Oe.tooltipIcon})}),F={navigation:{width:800,height:56},hero:{width:800,height:320},header:{width:800,height:80},section:{width:800,height:400},sidebar:{width:240,height:400},footer:{width:800,height:160},modal:{width:480,height:300},card:{width:280,height:240},text:{width:400,height:120},image:{width:320,height:200},video:{width:480,height:270},table:{width:560,height:220},grid:{width:600,height:300},list:{width:300,height:180},chart:{width:400,height:240},button:{width:140,height:40},input:{width:280,height:56},form:{width:360,height:320},tabs:{width:480,height:240},dropdown:{width:200,height:200},toggle:{width:44,height:24},search:{width:320,height:44},avatar:{width:48,height:48},badge:{width:80,height:28},breadcrumb:{width:300,height:24},pagination:{width:300,height:36},progress:{width:240,height:8},divider:{width:600,height:1},accordion:{width:400,height:200},carousel:{width:600,height:300},toast:{width:320,height:64},tooltip:{width:180,height:40},pricing:{width:300,height:360},testimonial:{width:360,height:200},cta:{width:600,height:160},alert:{width:400,height:56},banner:{width:800,height:48},stat:{width:200,height:120},stepper:{width:480,height:48},tag:{width:72,height:28},rating:{width:160,height:28},map:{width:480,height:300},timeline:{width:360,height:320},fileUpload:{width:360,height:180},codeBlock:{width:480,height:200},calendar:{width:300,height:300},notification:{width:360,height:72},productCard:{width:280,height:360},profile:{width:280,height:200},drawer:{width:320,height:400},popover:{width:240,height:160},logo:{width:120,height:40},faq:{width:560,height:320},gallery:{width:560,height:360},checkbox:{width:20,height:20},radio:{width:20,height:20},slider:{width:240,height:32},datePicker:{width:300,height:320},skeleton:{width:320,height:120},chip:{width:96,height:32},icon:{width:24,height:24},spinner:{width:32,height:32},feature:{width:360,height:200},team:{width:560,height:280},login:{width:360,height:360},contact:{width:400,height:320}},Ae=[{section:`Layout`,items:[{type:`navigation`,label:`Navigation`,...F.navigation},{type:`header`,label:`Header`,...F.header},{type:`hero`,label:`Hero`,...F.hero},{type:`section`,label:`Section`,...F.section},{type:`sidebar`,label:`Sidebar`,...F.sidebar},{type:`footer`,label:`Footer`,...F.footer},{type:`modal`,label:`Modal`,...F.modal},{type:`banner`,label:`Banner`,...F.banner},{type:`drawer`,label:`Drawer`,...F.drawer},{type:`popover`,label:`Popover`,...F.popover},{type:`divider`,label:`Divider`,...F.divider}]},{section:`Content`,items:[{type:`card`,label:`Card`,...F.card},{type:`text`,label:`Text`,...F.text},{type:`image`,label:`Image`,...F.image},{type:`video`,label:`Video`,...F.video},{type:`table`,label:`Table`,...F.table},{type:`grid`,label:`Grid`,...F.grid},{type:`list`,label:`List`,...F.list},{type:`chart`,label:`Chart`,...F.chart},{type:`codeBlock`,label:`Code Block`,...F.codeBlock},{type:`map`,label:`Map`,...F.map},{type:`timeline`,label:`Timeline`,...F.timeline},{type:`calendar`,label:`Calendar`,...F.calendar},{type:`accordion`,label:`Accordion`,...F.accordion},{type:`carousel`,label:`Carousel`,...F.carousel},{type:`logo`,label:`Logo`,...F.logo},{type:`faq`,label:`FAQ`,...F.faq},{type:`gallery`,label:`Gallery`,...F.gallery}]},{section:`Controls`,items:[{type:`button`,label:`Button`,...F.button},{type:`input`,label:`Input`,...F.input},{type:`search`,label:`Search`,...F.search},{type:`form`,label:`Form`,...F.form},{type:`tabs`,label:`Tabs`,...F.tabs},{type:`dropdown`,label:`Dropdown`,...F.dropdown},{type:`toggle`,label:`Toggle`,...F.toggle},{type:`stepper`,label:`Stepper`,...F.stepper},{type:`rating`,label:`Rating`,...F.rating},{type:`fileUpload`,label:`File Upload`,...F.fileUpload},{type:`checkbox`,label:`Checkbox`,...F.checkbox},{type:`radio`,label:`Radio`,...F.radio},{type:`slider`,label:`Slider`,...F.slider},{type:`datePicker`,label:`Date Picker`,...F.datePicker}]},{section:`Elements`,items:[{type:`avatar`,label:`Avatar`,...F.avatar},{type:`badge`,label:`Badge`,...F.badge},{type:`tag`,label:`Tag`,...F.tag},{type:`breadcrumb`,label:`Breadcrumb`,...F.breadcrumb},{type:`pagination`,label:`Pagination`,...F.pagination},{type:`progress`,label:`Progress`,...F.progress},{type:`alert`,label:`Alert`,...F.alert},{type:`toast`,label:`Toast`,...F.toast},{type:`notification`,label:`Notification`,...F.notification},{type:`tooltip`,label:`Tooltip`,...F.tooltip},{type:`stat`,label:`Stat`,...F.stat},{type:`skeleton`,label:`Skeleton`,...F.skeleton},{type:`chip`,label:`Chip`,...F.chip},{type:`icon`,label:`Icon`,...F.icon},{type:`spinner`,label:`Spinner`,...F.spinner}]},{section:`Blocks`,items:[{type:`pricing`,label:`Pricing`,...F.pricing},{type:`testimonial`,label:`Testimonial`,...F.testimonial},{type:`cta`,label:`CTA`,...F.cta},{type:`productCard`,label:`Product Card`,...F.productCard},{type:`profile`,label:`Profile`,...F.profile},{type:`feature`,label:`Feature`,...F.feature},{type:`team`,label:`Team`,...F.team},{type:`login`,label:`Login`,...F.login},{type:`contact`,label:`Contact`,...F.contact}]}],je={};for(let e of Ae)for(let t of e.items)je[t.type]=t;function I({w:e,h:t=3,strong:n}){return(0,S.jsx)(`div`,{style:{width:typeof e==`number`?`${e}px`:e,height:t,borderRadius:2,background:n?`var(--agd-bar-strong)`:`var(--agd-bar)`,flexShrink:0}})}function Me({w:e,h:t,radius:n=3,style:r}){return(0,S.jsx)(`div`,{style:{width:typeof e==`number`?`${e}px`:e,height:typeof t==`number`?`${t}px`:t,borderRadius:n,border:`1px dashed var(--agd-stroke)`,background:`var(--agd-fill)`,flexShrink:0,...r}})}function Ne({size:e}){return(0,S.jsx)(`div`,{style:{width:e,height:e,borderRadius:`50%`,border:`1px dashed var(--agd-stroke)`,background:`var(--agd-fill)`,flexShrink:0}})}function Pe({width:e,height:t}){return(0,S.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,height:`100%`,padding:`0 ${Math.max(8,t*.2)}px`,gap:e*.02},children:[(0,S.jsx)(Me,{w:Math.max(20,t*.5),h:Math.max(12,t*.4),radius:2}),(0,S.jsxs)(`div`,{style:{flex:1,display:`flex`,gap:e*.03,marginLeft:e*.04},children:[(0,S.jsx)(I,{w:e*.06}),(0,S.jsx)(I,{w:e*.07}),(0,S.jsx)(I,{w:e*.05}),(0,S.jsx)(I,{w:e*.06})]}),(0,S.jsx)(Me,{w:e*.1,h:Math.min(28,t*.5),radius:4})]})}function Fe({width:e,height:t,text:n}){return(0,S.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,alignItems:`center`,justifyContent:`center`,height:`100%`,gap:t*.05},children:[n?(0,S.jsx)(`span`,{style:{fontSize:Math.min(20,t*.08),fontWeight:600,color:`var(--agd-text-3)`,textAlign:`center`,maxWidth:`80%`},children:n}):(0,S.jsx)(I,{w:e*.5,h:Math.max(6,t*.04),strong:!0}),(0,S.jsx)(I,{w:e*.6}),(0,S.jsx)(I,{w:e*.4}),(0,S.jsx)(Me,{w:Math.min(140,e*.2),h:Math.min(36,t*.12),radius:6,style:{marginTop:t*.06}})]})}function Ie({width:e,height:t}){let n=Math.max(3,Math.floor(t/36));return(0,S.jsxs)(`div`,{style:{padding:e*.08,display:`flex`,flexDirection:`column`,gap:t*.03},children:[(0,S.jsx)(I,{w:e*.6,h:4,strong:!0}),Array.from({length:n},(t,n)=>(0,S.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:6},children:[(0,S.jsx)(Me,{w:10,h:10,radius:2}),(0,S.jsx)(I,{w:e*(.4+n*17%30/100)})]},n))]})}function L({width:e,height:t}){let n=Math.max(2,Math.min(4,Math.floor(e/160)));return(0,S.jsx)(`div`,{style:{display:`flex`,padding:`${t*.12}px ${e*.03}px`,gap:e*.05},children:Array.from({length:n},(e,t)=>(0,S.jsxs)(`div`,{style:{flex:1,display:`flex`,flexDirection:`column`,gap:4},children:[(0,S.jsx)(I,{w:`60%`,h:3,strong:!0}),(0,S.jsx)(I,{w:`80%`,h:2}),(0,S.jsx)(I,{w:`70%`,h:2}),(0,S.jsx)(I,{w:`60%`,h:2})]},t))})}function Le({width:e,height:t}){return(0,S.jsxs)(`div`,{style:{height:`100%`,display:`flex`,flexDirection:`column`},children:[(0,S.jsxs)(`div`,{style:{padding:`10px 12px`,borderBottom:`1px solid var(--agd-stroke)`,display:`flex`,alignItems:`center`,justifyContent:`space-between`},children:[(0,S.jsx)(I,{w:e*.3,h:4,strong:!0}),(0,S.jsx)(`div`,{style:{width:14,height:14,border:`1px solid var(--agd-stroke)`,borderRadius:3}})]}),(0,S.jsxs)(`div`,{style:{flex:1,padding:12,display:`flex`,flexDirection:`column`,gap:6},children:[(0,S.jsx)(I,{w:`90%`}),(0,S.jsx)(I,{w:`70%`}),(0,S.jsx)(I,{w:`80%`})]}),(0,S.jsxs)(`div`,{style:{padding:`10px 12px`,borderTop:`1px solid var(--agd-stroke)`,display:`flex`,justifyContent:`flex-end`,gap:8},children:[(0,S.jsx)(Me,{w:70,h:26,radius:4}),(0,S.jsx)(Me,{w:70,h:26,radius:4,style:{background:`var(--agd-bar)`}})]})]})}function Re({width:e,height:t}){return(0,S.jsxs)(`div`,{style:{height:`100%`,display:`flex`,flexDirection:`column`},children:[(0,S.jsx)(`div`,{style:{height:`40%`,background:`var(--agd-fill)`,borderBottom:`1px dashed var(--agd-stroke)`}}),(0,S.jsxs)(`div`,{style:{flex:1,padding:10,display:`flex`,flexDirection:`column`,gap:5},children:[(0,S.jsx)(I,{w:`70%`,h:4,strong:!0}),(0,S.jsx)(I,{w:`95%`,h:2}),(0,S.jsx)(I,{w:`85%`,h:2}),(0,S.jsx)(I,{w:`50%`,h:2})]})]})}function ze({width:e,height:t,text:n}){if(n)return(0,S.jsx)(`div`,{style:{padding:4,fontSize:Math.min(14,t*.3),lineHeight:1.5,color:`var(--agd-text-3)`,wordBreak:`break-word`,overflow:`hidden`},children:n});let r=Math.max(2,Math.floor(t/18));return(0,S.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:6,padding:4},children:[(0,S.jsx)(I,{w:e*.6,h:5,strong:!0}),Array.from({length:r},(e,t)=>(0,S.jsx)(I,{w:`${70+t*13%25}%`,h:2},t))]})}function Be({width:e,height:t}){return(0,S.jsx)(`div`,{style:{height:`100%`,position:`relative`},children:(0,S.jsxs)(`svg`,{width:`100%`,height:`100%`,viewBox:`0 0 ${e} ${t}`,preserveAspectRatio:`none`,fill:`none`,children:[(0,S.jsx)(`line`,{x1:`0`,y1:`0`,x2:e,y2:t,stroke:`var(--agd-stroke)`,strokeWidth:`1`}),(0,S.jsx)(`line`,{x1:e,y1:`0`,x2:`0`,y2:t,stroke:`var(--agd-stroke)`,strokeWidth:`1`}),(0,S.jsx)(`circle`,{cx:e*.3,cy:t*.3,r:Math.min(e,t)*.08,fill:`var(--agd-fill)`,stroke:`var(--agd-stroke)`,strokeWidth:`0.8`})]})})}function Ve({width:e,height:t}){let n=Math.max(2,Math.min(5,Math.floor(e/100))),r=Math.max(2,Math.min(6,Math.floor(t/32)));return(0,S.jsxs)(`div`,{style:{height:`100%`,display:`flex`,flexDirection:`column`},children:[(0,S.jsx)(`div`,{style:{display:`flex`,borderBottom:`1px solid var(--agd-stroke)`,padding:`6px 0`},children:Array.from({length:n},(e,t)=>(0,S.jsx)(`div`,{style:{flex:1,padding:`0 8px`},children:(0,S.jsx)(I,{w:`70%`,h:3,strong:!0})},t))}),Array.from({length:r},(e,t)=>(0,S.jsx)(`div`,{style:{display:`flex`,borderBottom:`1px solid rgba(255,255,255,0.03)`,padding:`6px 0`},children:Array.from({length:n},(e,n)=>(0,S.jsx)(`div`,{style:{flex:1,padding:`0 8px`},children:(0,S.jsx)(I,{w:`${50+(t*7+n*13)%40}%`,h:2})},n))},t))]})}function He({width:e,height:t}){let n=Math.max(2,Math.floor(t/28));return(0,S.jsx)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:4,padding:4},children:Array.from({length:n},(e,t)=>(0,S.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:8,padding:`4px 0`},children:[(0,S.jsx)(Ne,{size:8}),(0,S.jsx)(I,{w:`${55+t*17%35}%`,h:2})]},t))})}function Ue({width:e,height:t,text:n}){return(0,S.jsx)(`div`,{style:{height:`100%`,borderRadius:Math.min(8,t/3),border:`1px solid var(--agd-stroke)`,background:`var(--agd-fill)`,display:`flex`,alignItems:`center`,justifyContent:`center`},children:n?(0,S.jsx)(`span`,{style:{fontSize:Math.min(13,t*.4),fontWeight:500,color:`var(--agd-text-3)`,letterSpacing:`-0.01em`},children:n}):(0,S.jsx)(I,{w:Math.max(20,e*.5),h:3,strong:!0})})}function We({width:e,height:t}){return(0,S.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:4,height:`100%`,justifyContent:`center`},children:[(0,S.jsx)(I,{w:Math.min(80,e*.3),h:2}),(0,S.jsx)(`div`,{style:{height:Math.min(36,t*.6),borderRadius:4,border:`1px dashed var(--agd-stroke)`,background:`var(--agd-fill)`,display:`flex`,alignItems:`center`,paddingLeft:8},children:(0,S.jsx)(I,{w:`40%`,h:2})})]})}function Ge({width:e,height:t}){let n=Math.max(2,Math.min(5,Math.floor(t/56)));return(0,S.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:t*.04,padding:8},children:[Array.from({length:n},(e,t)=>(0,S.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:4},children:[(0,S.jsx)(I,{w:60+t*17%30,h:2}),(0,S.jsx)(Me,{w:`100%`,h:28,radius:4})]},t)),(0,S.jsx)(Me,{w:Math.min(120,e*.35),h:30,radius:6,style:{marginTop:8,alignSelf:`flex-end`,background:`var(--agd-bar)`}})]})}function R({width:e,height:t}){let n=Math.max(2,Math.min(4,Math.floor(e/120)));return(0,S.jsxs)(`div`,{style:{height:`100%`,display:`flex`,flexDirection:`column`},children:[(0,S.jsx)(`div`,{style:{display:`flex`,gap:2,borderBottom:`1px solid var(--agd-stroke)`},children:Array.from({length:n},(e,t)=>(0,S.jsx)(`div`,{style:{padding:`8px 12px`,borderBottom:t===0?`2px solid var(--agd-bar-strong)`:`none`},children:(0,S.jsx)(I,{w:60,h:3,strong:t===0})},t))}),(0,S.jsxs)(`div`,{style:{flex:1,padding:12,display:`flex`,flexDirection:`column`,gap:6},children:[(0,S.jsx)(I,{w:`80%`,h:2}),(0,S.jsx)(I,{w:`65%`,h:2}),(0,S.jsx)(I,{w:`75%`,h:2})]})]})}function Ke({width:e,height:t}){let n=Math.min(e,t)/2;return(0,S.jsxs)(`svg`,{width:`100%`,height:`100%`,viewBox:`0 0 ${e} ${t}`,fill:`none`,children:[(0,S.jsx)(`circle`,{cx:e/2,cy:t/2,r:n-1,stroke:`var(--agd-stroke)`,fill:`var(--agd-fill)`,strokeWidth:`1.5`,strokeDasharray:`3 2`}),(0,S.jsx)(`circle`,{cx:e/2,cy:t*.38,r:n*.28,stroke:`var(--agd-stroke)`,fill:`var(--agd-fill)`,strokeWidth:`0.8`}),(0,S.jsx)(`path`,{d:`M${e/2-n*.55} ${t*.78} C${e/2-n*.55} ${t*.55} ${e/2+n*.55} ${t*.55} ${e/2+n*.55} ${t*.78}`,stroke:`var(--agd-stroke)`,fill:`var(--agd-fill)`,strokeWidth:`0.8`})]})}function qe({width:e,height:t}){return(0,S.jsx)(`div`,{style:{height:`100%`,borderRadius:t/2,border:`1px solid var(--agd-stroke)`,background:`var(--agd-fill)`,display:`flex`,alignItems:`center`,justifyContent:`center`},children:(0,S.jsx)(I,{w:Math.max(16,e*.5),h:2,strong:!0})})}function Je({width:e,height:t}){return(0,S.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,alignItems:`center`,justifyContent:`center`,height:`100%`,gap:t*.08},children:[(0,S.jsx)(I,{w:e*.5,h:Math.max(5,t*.06),strong:!0}),(0,S.jsx)(I,{w:e*.35})]})}function Ye({width:e,height:t}){return(0,S.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,height:`100%`,gap:t*.04,padding:e*.04},children:[(0,S.jsx)(I,{w:e*.3,h:4,strong:!0}),(0,S.jsx)(I,{w:e*.7}),(0,S.jsx)(I,{w:e*.5}),(0,S.jsxs)(`div`,{style:{flex:1,display:`flex`,gap:e*.03,marginTop:t*.06},children:[(0,S.jsx)(Me,{w:`33%`,h:`100%`,radius:4}),(0,S.jsx)(Me,{w:`33%`,h:`100%`,radius:4}),(0,S.jsx)(Me,{w:`33%`,h:`100%`,radius:4})]})]})}function Xe({width:e,height:t}){let n=Math.max(2,Math.min(4,Math.floor(e/140))),r=Math.max(1,Math.min(3,Math.floor(t/120)));return(0,S.jsx)(`div`,{style:{display:`grid`,gridTemplateColumns:`repeat(${n}, 1fr)`,gridTemplateRows:`repeat(${r}, 1fr)`,gap:6,height:`100%`},children:Array.from({length:n*r},(e,t)=>(0,S.jsx)(Me,{w:`100%`,h:`100%`,radius:4},t))})}function Ze({width:e,height:t}){let n=Math.max(2,Math.floor((t-32)/28));return(0,S.jsxs)(`div`,{style:{height:`100%`,display:`flex`,flexDirection:`column`},children:[(0,S.jsx)(`div`,{style:{padding:`6px 8px`,borderBottom:`1px solid var(--agd-stroke)`},children:(0,S.jsx)(I,{w:e*.5,h:3,strong:!0})}),(0,S.jsx)(`div`,{style:{flex:1,padding:4,display:`flex`,flexDirection:`column`,gap:2},children:Array.from({length:n},(e,t)=>(0,S.jsx)(`div`,{style:{padding:`4px 6px`,borderRadius:3,background:t===0?`var(--agd-fill)`:`transparent`},children:(0,S.jsx)(I,{w:`${50+t*17%35}%`,h:2,strong:t===0})},t))})]})}function Qe({width:e,height:t}){let n=Math.min(e,t)/2;return(0,S.jsxs)(`svg`,{width:`100%`,height:`100%`,viewBox:`0 0 ${e} ${t}`,fill:`none`,children:[(0,S.jsx)(`rect`,{x:`1`,y:`1`,width:e-2,height:t-2,rx:n,stroke:`var(--agd-stroke)`,strokeWidth:`1`}),(0,S.jsx)(`circle`,{cx:e-n,cy:t/2,r:n*.7,fill:`var(--agd-bar)`})]})}function $e({width:e,height:t}){let n=Math.min(t/2,20);return(0,S.jsxs)(`div`,{style:{height:`100%`,borderRadius:n,border:`1px dashed var(--agd-stroke)`,background:`var(--agd-fill)`,display:`flex`,alignItems:`center`,padding:`0 ${n*.6}px`,gap:6},children:[(0,S.jsx)(Ne,{size:Math.min(14,t*.4)}),(0,S.jsx)(I,{w:`50%`,h:2})]})}function et({width:e,height:t}){return(0,S.jsxs)(`div`,{style:{height:`100%`,borderRadius:8,border:`1px dashed var(--agd-stroke)`,background:`var(--agd-fill)`,display:`flex`,alignItems:`center`,padding:`0 10px`,gap:8},children:[(0,S.jsx)(Ne,{size:Math.min(20,t*.5)}),(0,S.jsxs)(`div`,{style:{flex:1,display:`flex`,flexDirection:`column`,gap:3},children:[(0,S.jsx)(I,{w:`60%`,h:3,strong:!0}),(0,S.jsx)(I,{w:`80%`,h:2})]}),(0,S.jsx)(`div`,{style:{width:14,height:14,border:`1px solid var(--agd-stroke)`,borderRadius:3,flexShrink:0}})]})}function tt({width:e,height:t}){return(0,S.jsxs)(`svg`,{width:`100%`,height:`100%`,viewBox:`0 0 ${e} ${t}`,fill:`none`,children:[(0,S.jsx)(`rect`,{x:`0`,y:`0`,width:e,height:t,rx:t/2,stroke:`var(--agd-stroke)`,strokeWidth:`0.8`}),(0,S.jsx)(`rect`,{x:`1`,y:`1`,width:e*.65,height:t-2,rx:(t-2)/2,fill:`var(--agd-bar)`})]})}function nt({width:e,height:t}){let n=Math.max(3,Math.min(7,Math.floor(e/50))),r=e/(n*2);return(0,S.jsx)(`div`,{style:{height:`100%`,display:`flex`,alignItems:`flex-end`,justifyContent:`space-around`,padding:`0 4px`,borderBottom:`1px solid var(--agd-stroke)`},children:Array.from({length:n},(e,t)=>(0,S.jsx)(Me,{w:r,h:`${30+(t*37+17)%55}%`,radius:2},t))})}function z({width:e,height:t}){let n=Math.min(e,t)*.12;return(0,S.jsxs)(`div`,{style:{height:`100%`,position:`relative`,display:`flex`,alignItems:`center`,justifyContent:`center`},children:[(0,S.jsx)(Me,{w:`100%`,h:`100%`,radius:4}),(0,S.jsx)(`div`,{style:{position:`absolute`,width:n*2,height:n*2,borderRadius:`50%`,border:`1.5px solid var(--agd-stroke)`,background:`var(--agd-fill)`,display:`flex`,alignItems:`center`,justifyContent:`center`},children:(0,S.jsx)(`div`,{style:{width:0,height:0,borderLeft:`${n*.6}px solid var(--agd-bar-strong)`,borderTop:`${n*.4}px solid transparent`,borderBottom:`${n*.4}px solid transparent`,marginLeft:n*.15}})})]})}function rt({width:e,height:t}){return(0,S.jsxs)(`div`,{style:{height:`100%`,display:`flex`,flexDirection:`column`,alignItems:`center`},children:[(0,S.jsx)(`div`,{style:{flex:1,width:`100%`,borderRadius:6,border:`1px dashed var(--agd-stroke)`,background:`var(--agd-fill)`,display:`flex`,alignItems:`center`,justifyContent:`center`},children:(0,S.jsx)(I,{w:`60%`,h:2})}),(0,S.jsx)(`div`,{style:{width:8,height:8,background:`var(--agd-fill)`,border:`1px dashed var(--agd-stroke)`,borderTop:`none`,borderLeft:`none`,transform:`rotate(45deg)`,marginTop:-5}})]})}function it({width:e,height:t}){let n=Math.max(2,Math.min(4,Math.floor(e/80)));return(0,S.jsx)(`div`,{style:{display:`flex`,alignItems:`center`,height:`100%`,gap:4},children:Array.from({length:n},(e,t)=>(0,S.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:4},children:[t>0&&(0,S.jsx)(`span`,{style:{color:`var(--agd-stroke)`,fontSize:10},children:`/`}),(0,S.jsx)(I,{w:40+t*13%20,h:2,strong:t===n-1})]},t))})}function at({width:e,height:t}){let n=Math.max(3,Math.min(5,Math.floor(e/40))),r=Math.min(28,t*.8);return(0,S.jsx)(`div`,{style:{display:`flex`,alignItems:`center`,justifyContent:`center`,height:`100%`,gap:4},children:Array.from({length:n},(e,t)=>(0,S.jsx)(Me,{w:r,h:r,radius:4,style:t===1?{background:`var(--agd-bar)`}:void 0},t))})}function B({width:e}){return(0,S.jsx)(`div`,{style:{display:`flex`,alignItems:`center`,height:`100%`},children:(0,S.jsx)(`div`,{style:{width:`100%`,height:1,background:`var(--agd-stroke)`}})})}function ot({width:e,height:t}){let n=Math.max(2,Math.min(4,Math.floor(t/40)));return(0,S.jsx)(`div`,{style:{display:`flex`,flexDirection:`column`,height:`100%`},children:Array.from({length:n},(e,t)=>(0,S.jsxs)(`div`,{style:{borderBottom:`1px solid var(--agd-stroke)`,padding:`8px 6px`,display:`flex`,alignItems:`center`,justifyContent:`space-between`,flex:t===0?2:1},children:[(0,S.jsx)(I,{w:`${40+t*17%25}%`,h:3,strong:!0}),(0,S.jsx)(`span`,{style:{fontSize:8,color:`var(--agd-stroke)`},children:t===0?`▼`:`▶`})]},t))})}function st({width:e,height:t}){return(0,S.jsxs)(`div`,{style:{height:`100%`,display:`flex`,flexDirection:`column`,gap:6},children:[(0,S.jsxs)(`div`,{style:{flex:1,display:`flex`,gap:6,alignItems:`center`},children:[(0,S.jsx)(`span`,{style:{fontSize:12,color:`var(--agd-stroke)`},children:`‹`}),(0,S.jsx)(Me,{w:`100%`,h:`100%`,radius:4}),(0,S.jsx)(`span`,{style:{fontSize:12,color:`var(--agd-stroke)`},children:`›`})]}),(0,S.jsxs)(`div`,{style:{display:`flex`,justifyContent:`center`,gap:4},children:[(0,S.jsx)(Ne,{size:5}),(0,S.jsx)(Ne,{size:5}),(0,S.jsx)(Ne,{size:5})]})]})}function ct({width:e,height:t}){return(0,S.jsxs)(`div`,{style:{height:`100%`,display:`flex`,flexDirection:`column`,alignItems:`center`,padding:10,gap:t*.04},children:[(0,S.jsx)(I,{w:e*.4,h:3,strong:!0}),(0,S.jsx)(I,{w:e*.3,h:6,strong:!0}),(0,S.jsx)(`div`,{style:{flex:1,display:`flex`,flexDirection:`column`,gap:4,width:`100%`,padding:`8px 0`},children:Array.from({length:4},(e,t)=>(0,S.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:4},children:[(0,S.jsx)(Ne,{size:5}),(0,S.jsx)(I,{w:`${50+t*17%35}%`,h:2})]},t))}),(0,S.jsx)(Me,{w:e*.7,h:Math.min(32,t*.1),radius:6,style:{background:`var(--agd-bar)`}})]})}function lt({width:e,height:t}){return(0,S.jsxs)(`div`,{style:{height:`100%`,display:`flex`,flexDirection:`column`,padding:10,gap:8},children:[(0,S.jsx)(`span`,{style:{fontSize:18,lineHeight:1,color:`var(--agd-stroke)`,fontFamily:`serif`},children:`“`}),(0,S.jsxs)(`div`,{style:{flex:1,display:`flex`,flexDirection:`column`,gap:4},children:[(0,S.jsx)(I,{w:`90%`,h:2}),(0,S.jsx)(I,{w:`75%`,h:2}),(0,S.jsx)(I,{w:`60%`,h:2})]}),(0,S.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:6},children:[(0,S.jsx)(Ne,{size:20}),(0,S.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:2},children:[(0,S.jsx)(I,{w:60,h:3,strong:!0}),(0,S.jsx)(I,{w:40,h:2})]})]})]})}function ut({width:e,height:t}){return(0,S.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,alignItems:`center`,justifyContent:`center`,height:`100%`,gap:t*.08},children:[(0,S.jsx)(I,{w:e*.5,h:Math.max(4,t*.05),strong:!0}),(0,S.jsx)(I,{w:e*.35}),(0,S.jsx)(Me,{w:Math.min(140,e*.25),h:Math.min(32,t*.15),radius:6,style:{marginTop:t*.04,background:`var(--agd-bar)`}})]})}function dt({width:e,height:t}){return(0,S.jsxs)(`div`,{style:{height:`100%`,borderRadius:6,border:`1px dashed var(--agd-stroke)`,background:`var(--agd-fill)`,display:`flex`,alignItems:`center`,padding:`0 10px`,gap:8},children:[(0,S.jsx)(`div`,{style:{width:16,height:16,borderRadius:`50%`,border:`1.5px solid var(--agd-bar-strong)`,display:`flex`,alignItems:`center`,justifyContent:`center`,flexShrink:0},children:(0,S.jsx)(`div`,{style:{width:2,height:6,background:`var(--agd-bar-strong)`,borderRadius:1}})}),(0,S.jsxs)(`div`,{style:{flex:1,display:`flex`,flexDirection:`column`,gap:3},children:[(0,S.jsx)(I,{w:`40%`,h:3,strong:!0}),(0,S.jsx)(I,{w:`70%`,h:2})]})]})}function ft({width:e,height:t}){return(0,S.jsxs)(`div`,{style:{height:`100%`,background:`var(--agd-fill)`,display:`flex`,alignItems:`center`,justifyContent:`center`,gap:8,padding:`0 12px`},children:[(0,S.jsx)(I,{w:e*.4,h:3,strong:!0}),(0,S.jsx)(Me,{w:60,h:Math.min(24,t*.6),radius:4})]})}function pt({width:e,height:t}){return(0,S.jsxs)(`div`,{style:{height:`100%`,display:`flex`,flexDirection:`column`,alignItems:`center`,justifyContent:`center`,gap:t*.06},children:[(0,S.jsx)(I,{w:e*.5,h:2}),(0,S.jsx)(I,{w:e*.4,h:Math.max(8,t*.18),strong:!0}),(0,S.jsx)(I,{w:e*.3,h:2})]})}function mt({width:e,height:t}){let n=Math.max(3,Math.min(5,Math.floor(e/100))),r=Math.min(12,t*.35);return(0,S.jsx)(`div`,{style:{display:`flex`,alignItems:`center`,justifyContent:`space-between`,height:`100%`,padding:`0 8px`},children:Array.from({length:n},(e,t)=>(0,S.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:0,flex:1},children:[(0,S.jsx)(`div`,{style:{width:r,height:r,borderRadius:`50%`,border:`1.5px solid var(--agd-stroke)`,background:t===0?`var(--agd-bar)`:`transparent`,flexShrink:0}}),t<n-1&&(0,S.jsx)(`div`,{style:{flex:1,height:1,background:`var(--agd-stroke)`,margin:`0 4px`}})]},t))})}function ht({width:e,height:t}){return(0,S.jsxs)(`div`,{style:{height:`100%`,borderRadius:4,border:`1px solid var(--agd-stroke)`,background:`var(--agd-fill)`,display:`flex`,alignItems:`center`,justifyContent:`center`,gap:4,padding:`0 6px`},children:[(0,S.jsx)(I,{w:Math.max(16,e*.5),h:2,strong:!0}),(0,S.jsx)(`div`,{style:{width:8,height:8,borderRadius:`50%`,border:`1px solid var(--agd-stroke)`,flexShrink:0}})]})}function gt({width:e,height:t}){let n=Math.min(t*.7,e/(5*1.5));return(0,S.jsx)(`div`,{style:{display:`flex`,alignItems:`center`,justifyContent:`center`,height:`100%`,gap:n*.2},children:Array.from({length:5},(e,t)=>(0,S.jsx)(`svg`,{width:n,height:n,viewBox:`0 0 16 16`,fill:`none`,children:(0,S.jsx)(`path`,{d:`M8 1.5l2 4 4.5.7-3.25 3.1.75 4.5L8 11.4l-4 2.4.75-4.5L1.5 6.2 6 5.5z`,stroke:`var(--agd-stroke)`,strokeWidth:`0.8`,fill:t<3?`var(--agd-bar)`:`none`})},t))})}function _t({width:e,height:t}){return(0,S.jsxs)(`div`,{style:{height:`100%`,position:`relative`,borderRadius:4,border:`1px dashed var(--agd-stroke)`,background:`var(--agd-fill)`,overflow:`hidden`},children:[(0,S.jsxs)(`svg`,{width:`100%`,height:`100%`,viewBox:`0 0 ${e} ${t}`,fill:`none`,style:{position:`absolute`,inset:0},children:[(0,S.jsx)(`line`,{x1:0,y1:t*.3,x2:e,y2:t*.7,stroke:`var(--agd-stroke)`,strokeWidth:`0.5`,opacity:`.2`}),(0,S.jsx)(`line`,{x1:0,y1:t*.6,x2:e,y2:t*.2,stroke:`var(--agd-stroke)`,strokeWidth:`0.5`,opacity:`.15`}),(0,S.jsx)(`line`,{x1:e*.4,y1:0,x2:e*.6,y2:t,stroke:`var(--agd-stroke)`,strokeWidth:`0.5`,opacity:`.15`})]}),(0,S.jsx)(`div`,{style:{position:`absolute`,left:`50%`,top:`40%`,transform:`translate(-50%, -100%)`},children:(0,S.jsxs)(`svg`,{width:`16`,height:`22`,viewBox:`0 0 16 22`,fill:`none`,children:[(0,S.jsx)(`path`,{d:`M8 0C3.6 0 0 3.6 0 8c0 6 8 14 8 14s8-8 8-14c0-4.4-3.6-8-8-8z`,fill:`var(--agd-bar)`,opacity:`.4`}),(0,S.jsx)(`circle`,{cx:`8`,cy:`8`,r:`3`,fill:`var(--agd-fill)`})]})})]})}function vt({width:e,height:t}){let n=Math.max(3,Math.min(5,Math.floor(t/60)));return(0,S.jsxs)(`div`,{style:{display:`flex`,height:`100%`,padding:`8px 0`},children:[(0,S.jsx)(`div`,{style:{width:16,display:`flex`,flexDirection:`column`,alignItems:`center`},children:Array.from({length:n},(e,t)=>(0,S.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,alignItems:`center`,flex:1},children:[(0,S.jsx)(Ne,{size:8}),t<n-1&&(0,S.jsx)(`div`,{style:{flex:1,width:1,background:`var(--agd-stroke)`}})]},t))}),(0,S.jsx)(`div`,{style:{flex:1,display:`flex`,flexDirection:`column`,justifyContent:`space-around`,paddingLeft:8},children:Array.from({length:n},(e,t)=>(0,S.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:3},children:[(0,S.jsx)(I,{w:`${35+t*13%25}%`,h:3,strong:!0}),(0,S.jsx)(I,{w:`${50+t*17%30}%`,h:2})]},t))})]})}function yt({width:e,height:t}){return(0,S.jsxs)(`div`,{style:{height:`100%`,borderRadius:8,border:`2px dashed var(--agd-stroke)`,display:`flex`,flexDirection:`column`,alignItems:`center`,justifyContent:`center`,gap:t*.06},children:[(0,S.jsxs)(`svg`,{width:`24`,height:`24`,viewBox:`0 0 24 24`,fill:`none`,children:[(0,S.jsx)(`path`,{d:`M12 16V4m0 0l-4 4m4-4l4 4`,stroke:`var(--agd-stroke)`,strokeWidth:`1.5`}),(0,S.jsx)(`path`,{d:`M4 17v2a1 1 0 001 1h14a1 1 0 001-1v-2`,stroke:`var(--agd-stroke)`,strokeWidth:`1.5`})]}),(0,S.jsx)(I,{w:e*.4,h:2}),(0,S.jsx)(I,{w:e*.25,h:2})]})}function bt({width:e,height:t}){let n=Math.max(3,Math.min(8,Math.floor(t/20)));return(0,S.jsxs)(`div`,{style:{height:`100%`,borderRadius:6,background:`var(--agd-fill)`,border:`1px solid var(--agd-stroke)`,padding:8,display:`flex`,flexDirection:`column`,gap:4},children:[(0,S.jsxs)(`div`,{style:{display:`flex`,gap:3,marginBottom:4},children:[(0,S.jsx)(Ne,{size:6}),(0,S.jsx)(Ne,{size:6}),(0,S.jsx)(Ne,{size:6})]}),Array.from({length:n},(e,t)=>(0,S.jsx)(`div`,{style:{display:`flex`,gap:6,paddingLeft:t>0&&t<n-1?12:0},children:(0,S.jsx)(I,{w:`${25+t*23%50}%`,h:2,strong:t===0})},t))]})}function xt({width:e,height:t}){let n=Math.min((e-16)/7,(t-40)/6);return(0,S.jsxs)(`div`,{style:{height:`100%`,display:`flex`,flexDirection:`column`},children:[(0,S.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,justifyContent:`space-between`,padding:`6px 8px`},children:[(0,S.jsx)(`span`,{style:{fontSize:8,color:`var(--agd-stroke)`},children:`‹`}),(0,S.jsx)(I,{w:e*.3,h:3,strong:!0}),(0,S.jsx)(`span`,{style:{fontSize:8,color:`var(--agd-stroke)`},children:`›`})]}),(0,S.jsxs)(`div`,{style:{display:`grid`,gridTemplateColumns:`repeat(7, 1fr)`,gap:2,padding:`0 4px`,flex:1},children:[Array.from({length:7},(e,t)=>(0,S.jsx)(`div`,{style:{display:`flex`,alignItems:`center`,justifyContent:`center`,height:n*.6},children:(0,S.jsx)(I,{w:n*.5,h:2})},`h${t}`)),Array.from({length:35},(e,t)=>(0,S.jsx)(`div`,{style:{display:`flex`,alignItems:`center`,justifyContent:`center`,height:n},children:(0,S.jsx)(`div`,{style:{width:n*.6,height:n*.6,borderRadius:`50%`,background:t===12?`var(--agd-bar)`:`transparent`,display:`flex`,alignItems:`center`,justifyContent:`center`},children:(0,S.jsx)(`div`,{style:{width:2,height:2,borderRadius:1,background:`var(--agd-bar-strong)`,opacity:t===12?1:.3}})})},t))]})]})}function V({width:e,height:t}){return(0,S.jsxs)(`div`,{style:{height:`100%`,borderRadius:8,border:`1px dashed var(--agd-stroke)`,background:`var(--agd-fill)`,display:`flex`,alignItems:`center`,padding:`0 10px`,gap:8},children:[(0,S.jsx)(Ne,{size:Math.min(32,t*.55)}),(0,S.jsxs)(`div`,{style:{flex:1,display:`flex`,flexDirection:`column`,gap:3},children:[(0,S.jsx)(I,{w:`50%`,h:3,strong:!0}),(0,S.jsx)(I,{w:`75%`,h:2})]}),(0,S.jsx)(I,{w:30,h:2})]})}function St({width:e,height:t}){return(0,S.jsxs)(`div`,{style:{height:`100%`,display:`flex`,flexDirection:`column`},children:[(0,S.jsx)(`div`,{style:{height:`50%`,background:`var(--agd-fill)`,borderBottom:`1px dashed var(--agd-stroke)`}}),(0,S.jsxs)(`div`,{style:{flex:1,padding:10,display:`flex`,flexDirection:`column`,gap:5},children:[(0,S.jsx)(I,{w:`65%`,h:4,strong:!0}),(0,S.jsx)(I,{w:`40%`,h:3}),(0,S.jsx)(`div`,{style:{flex:1}}),(0,S.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,justifyContent:`space-between`},children:[(0,S.jsx)(I,{w:`30%`,h:5,strong:!0}),(0,S.jsx)(Me,{w:Math.min(70,e*.3),h:26,radius:4,style:{background:`var(--agd-bar)`}})]})]})]})}function Ct({width:e,height:t}){let n=Math.min(48,t*.3);return(0,S.jsxs)(`div`,{style:{height:`100%`,display:`flex`,flexDirection:`column`,alignItems:`center`,justifyContent:`center`,gap:t*.06},children:[(0,S.jsx)(Ne,{size:n}),(0,S.jsx)(I,{w:e*.45,h:4,strong:!0}),(0,S.jsx)(I,{w:e*.3,h:2}),(0,S.jsxs)(`div`,{style:{display:`flex`,gap:e*.08,marginTop:t*.04},children:[(0,S.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,alignItems:`center`,gap:2},children:[(0,S.jsx)(I,{w:20,h:3,strong:!0}),(0,S.jsx)(I,{w:28,h:2})]}),(0,S.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,alignItems:`center`,gap:2},children:[(0,S.jsx)(I,{w:20,h:3,strong:!0}),(0,S.jsx)(I,{w:28,h:2})]}),(0,S.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,alignItems:`center`,gap:2},children:[(0,S.jsx)(I,{w:20,h:3,strong:!0}),(0,S.jsx)(I,{w:28,h:2})]})]})]})}function wt({width:e,height:t}){let n=Math.max(e*.6,80),r=Math.max(3,Math.floor(t/40));return(0,S.jsxs)(`div`,{style:{height:`100%`,display:`flex`},children:[(0,S.jsx)(`div`,{style:{width:e-n,background:`var(--agd-fill)`,opacity:.3}}),(0,S.jsxs)(`div`,{style:{flex:1,borderLeft:`1px solid var(--agd-stroke)`,display:`flex`,flexDirection:`column`,padding:e*.04},children:[(0,S.jsxs)(`div`,{style:{display:`flex`,justifyContent:`space-between`,alignItems:`center`,marginBottom:t*.06},children:[(0,S.jsx)(I,{w:n*.4,h:4,strong:!0}),(0,S.jsx)(`div`,{style:{width:12,height:12,border:`1px solid var(--agd-stroke)`,borderRadius:3}})]}),Array.from({length:r},(e,t)=>(0,S.jsx)(`div`,{style:{padding:`6px 0`},children:(0,S.jsx)(I,{w:`${50+t*17%35}%`,h:2,strong:t===0})},t))]})]})}function Tt({width:e,height:t}){return(0,S.jsxs)(`div`,{style:{height:`100%`,display:`flex`,flexDirection:`column`,alignItems:`center`},children:[(0,S.jsxs)(`div`,{style:{flex:1,width:`100%`,borderRadius:8,border:`1px dashed var(--agd-stroke)`,background:`var(--agd-fill)`,padding:10,display:`flex`,flexDirection:`column`,gap:5},children:[(0,S.jsx)(I,{w:`70%`,h:3,strong:!0}),(0,S.jsx)(I,{w:`90%`,h:2}),(0,S.jsx)(I,{w:`60%`,h:2})]}),(0,S.jsx)(`div`,{style:{width:10,height:10,background:`var(--agd-fill)`,border:`1px dashed var(--agd-stroke)`,borderTop:`none`,borderLeft:`none`,transform:`rotate(45deg)`,marginTop:-6}})]})}function Et({width:e,height:t}){let n=Math.min(t*.7,e*.3);return(0,S.jsxs)(`div`,{style:{height:`100%`,display:`flex`,alignItems:`center`,gap:e*.08},children:[(0,S.jsx)(Me,{w:n,h:n,radius:n*.25}),(0,S.jsx)(I,{w:e*.45,h:Math.max(4,t*.2),strong:!0})]})}function Dt({width:e,height:t}){let n=Math.max(2,Math.min(5,Math.floor(t/56)));return(0,S.jsx)(`div`,{style:{display:`flex`,flexDirection:`column`,height:`100%`},children:Array.from({length:n},(t,n)=>(0,S.jsxs)(`div`,{style:{borderBottom:`1px solid var(--agd-stroke)`,padding:`8px 6px`,display:`flex`,alignItems:`center`,justifyContent:`space-between`,flex:n===0?2:1},children:[(0,S.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:6},children:[(0,S.jsx)(`span`,{style:{fontSize:9,fontWeight:700,color:`var(--agd-stroke)`},children:`Q`}),(0,S.jsx)(I,{w:e*(.3+n*13%25/100),h:3,strong:!0})]}),(0,S.jsx)(`span`,{style:{fontSize:8,color:`var(--agd-stroke)`},children:n===0?`▼`:`▶`})]},n))})}function Ot({width:e,height:t}){let n=Math.max(2,Math.min(4,Math.floor(e/120))),r=Math.max(1,Math.min(3,Math.floor(t/120)));return(0,S.jsx)(`div`,{style:{display:`grid`,gridTemplateColumns:`repeat(${n}, 1fr)`,gridTemplateRows:`repeat(${r}, 1fr)`,gap:4,height:`100%`},children:Array.from({length:n*r},(e,t)=>(0,S.jsx)(`div`,{style:{borderRadius:4,border:`1px dashed var(--agd-stroke)`,background:`var(--agd-fill)`,position:`relative`,overflow:`hidden`},children:(0,S.jsxs)(`svg`,{width:`100%`,height:`100%`,viewBox:`0 0 100 100`,preserveAspectRatio:`none`,fill:`none`,children:[(0,S.jsx)(`line`,{x1:`0`,y1:`0`,x2:`100`,y2:`100`,stroke:`var(--agd-stroke)`,strokeWidth:`0.5`}),(0,S.jsx)(`line`,{x1:`100`,y1:`0`,x2:`0`,y2:`100`,stroke:`var(--agd-stroke)`,strokeWidth:`0.5`})]})},t))})}function kt({width:e,height:t}){let n=Math.min(e,t);return(0,S.jsxs)(`svg`,{width:`100%`,height:`100%`,viewBox:`0 0 ${e} ${t}`,fill:`none`,children:[(0,S.jsx)(`rect`,{x:`1`,y:(t-n+2)/2,width:n-2,height:n-2,rx:n*.15,stroke:`var(--agd-stroke)`,strokeWidth:`1.5`}),(0,S.jsx)(`path`,{d:`M${n*.25} ${t/2}l${n*.2} ${n*.2} ${n*.3}-${n*.35}`,stroke:`var(--agd-bar)`,strokeWidth:`1.5`,fill:`none`,strokeLinecap:`round`,strokeLinejoin:`round`})]})}function At({width:e,height:t}){let n=Math.min(e,t)/2-1;return(0,S.jsxs)(`svg`,{width:`100%`,height:`100%`,viewBox:`0 0 ${e} ${t}`,fill:`none`,children:[(0,S.jsx)(`circle`,{cx:e/2,cy:t/2,r:n,stroke:`var(--agd-stroke)`,strokeWidth:`1.5`}),(0,S.jsx)(`circle`,{cx:e/2,cy:t/2,r:n*.45,fill:`var(--agd-bar)`})]})}function jt({width:e,height:t}){let n=Math.max(2,t*.12),r=Math.min(t*.35,10),i=e*.55;return(0,S.jsxs)(`div`,{style:{height:`100%`,display:`flex`,alignItems:`center`,position:`relative`},children:[(0,S.jsx)(`div`,{style:{width:`100%`,height:n,borderRadius:n/2,background:`var(--agd-fill)`,border:`1px solid var(--agd-stroke)`,position:`relative`},children:(0,S.jsx)(`div`,{style:{width:i,height:`100%`,borderRadius:n/2,background:`var(--agd-bar)`}})}),(0,S.jsx)(`div`,{style:{position:`absolute`,left:i-r,width:r*2,height:r*2,borderRadius:`50%`,border:`1.5px solid var(--agd-stroke)`,background:`var(--agd-fill)`}})]})}function Mt({width:e,height:t}){let n=Math.min(36,t*.15),r=Math.min((e-16)/7,(t-n-40)/5);return(0,S.jsxs)(`div`,{style:{height:`100%`,display:`flex`,flexDirection:`column`,gap:4},children:[(0,S.jsxs)(`div`,{style:{height:n,borderRadius:4,border:`1px dashed var(--agd-stroke)`,background:`var(--agd-fill)`,display:`flex`,alignItems:`center`,padding:`0 8px`,justifyContent:`space-between`},children:[(0,S.jsx)(I,{w:`40%`,h:2}),(0,S.jsxs)(`svg`,{width:`12`,height:`12`,viewBox:`0 0 16 16`,fill:`none`,children:[(0,S.jsx)(`rect`,{x:`2`,y:`3`,width:`12`,height:`11`,rx:`1`,stroke:`var(--agd-stroke)`,strokeWidth:`1`}),(0,S.jsx)(`line`,{x1:`2`,y1:`6`,x2:`14`,y2:`6`,stroke:`var(--agd-stroke)`,strokeWidth:`0.5`})]})]}),(0,S.jsxs)(`div`,{style:{flex:1,borderRadius:6,border:`1px dashed var(--agd-stroke)`,background:`var(--agd-fill)`,display:`flex`,flexDirection:`column`},children:[(0,S.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,justifyContent:`space-between`,padding:`4px 6px`},children:[(0,S.jsx)(`span`,{style:{fontSize:7,color:`var(--agd-stroke)`},children:`‹`}),(0,S.jsx)(I,{w:e*.25,h:2,strong:!0}),(0,S.jsx)(`span`,{style:{fontSize:7,color:`var(--agd-stroke)`},children:`›`})]}),(0,S.jsx)(`div`,{style:{display:`grid`,gridTemplateColumns:`repeat(7, 1fr)`,gap:1,padding:`0 4px`,flex:1},children:Array.from({length:28},(e,t)=>(0,S.jsx)(`div`,{style:{display:`flex`,alignItems:`center`,justifyContent:`center`,height:r},children:(0,S.jsx)(`div`,{style:{width:r*.5,height:r*.5,borderRadius:`50%`,background:t===10?`var(--agd-bar)`:`transparent`},children:(0,S.jsx)(`div`,{style:{width:`100%`,height:`100%`,display:`flex`,alignItems:`center`,justifyContent:`center`},children:(0,S.jsx)(`div`,{style:{width:1.5,height:1.5,borderRadius:1,background:`var(--agd-bar-strong)`,opacity:t===10?1:.25}})})})},t))})]})]})}function Nt({width:e,height:t}){return(0,S.jsxs)(`div`,{style:{height:`100%`,display:`flex`,flexDirection:`column`,gap:t*.08,padding:4},children:[(0,S.jsx)(`div`,{style:{width:`100%`,height:t*.2,borderRadius:4,background:`var(--agd-fill)`}}),(0,S.jsx)(`div`,{style:{width:`70%`,height:Math.max(6,t*.1),borderRadius:3,background:`var(--agd-fill)`}}),(0,S.jsx)(`div`,{style:{width:`90%`,height:Math.max(4,t*.06),borderRadius:3,background:`var(--agd-fill)`}}),(0,S.jsx)(`div`,{style:{width:`50%`,height:Math.max(4,t*.06),borderRadius:3,background:`var(--agd-fill)`}})]})}function Pt({width:e,height:t}){return(0,S.jsx)(`div`,{style:{height:`100%`,display:`flex`,alignItems:`center`,gap:6},children:(0,S.jsxs)(`div`,{style:{height:`100%`,flex:1,borderRadius:t/2,border:`1px solid var(--agd-stroke)`,background:`var(--agd-fill)`,display:`flex`,alignItems:`center`,padding:`0 ${t*.3}px`,gap:4},children:[(0,S.jsx)(I,{w:`60%`,h:2,strong:!0}),(0,S.jsx)(`div`,{style:{width:Math.max(6,t*.3),height:Math.max(6,t*.3),borderRadius:`50%`,border:`1px solid var(--agd-stroke)`,flexShrink:0,marginLeft:`auto`}})]})})}function Ft({width:e,height:t}){let n=Math.min(e,t);return(0,S.jsx)(`svg`,{width:`100%`,height:`100%`,viewBox:`0 0 ${e} ${t}`,fill:`none`,children:(0,S.jsx)(`path`,{d:`M${e/2} ${(t-n)/2+n*.1}l${n*.12} ${n*.25} ${n*.28} ${n*.04}-${n*.2} ${n*.2} ${n*.05} ${n*.28}-${n*.25}-${n*.12}-${n*.25} ${n*.12} ${n*.05}-${n*.28}-${n*.2}-${n*.2} ${n*.28}-${n*.04}z`,stroke:`var(--agd-stroke)`,strokeWidth:`1`,fill:`var(--agd-fill)`})})}function It({width:e,height:t}){let n=Math.min(e,t)/2-2;return(0,S.jsxs)(`svg`,{width:`100%`,height:`100%`,viewBox:`0 0 ${e} ${t}`,fill:`none`,children:[(0,S.jsx)(`circle`,{cx:e/2,cy:t/2,r:n,stroke:`var(--agd-stroke)`,strokeWidth:`1.5`,opacity:`.2`}),(0,S.jsx)(`path`,{d:`M${e/2} ${t/2-n}a${n} ${n} 0 0 1 ${n} ${n}`,stroke:`var(--agd-bar-strong)`,strokeWidth:`1.5`,strokeLinecap:`round`})]})}function Lt({width:e,height:t}){let n=Math.min(36,t*.25,e*.12),r=Math.max(1,Math.min(3,Math.floor(t/80)));return(0,S.jsx)(`div`,{style:{display:`flex`,flexDirection:`column`,height:`100%`,justifyContent:`space-around`,padding:8},children:Array.from({length:r},(t,r)=>(0,S.jsxs)(`div`,{style:{display:`flex`,gap:e*.04,alignItems:`flex-start`},children:[(0,S.jsx)(Me,{w:n,h:n,radius:n*.25}),(0,S.jsxs)(`div`,{style:{flex:1,display:`flex`,flexDirection:`column`,gap:4},children:[(0,S.jsx)(I,{w:`${40+r*13%20}%`,h:3,strong:!0}),(0,S.jsx)(I,{w:`${60+r*17%25}%`,h:2})]})]},r))})}function Rt({width:e,height:t}){let n=Math.max(2,Math.min(4,Math.floor(e/120))),r=Math.min(36,t*.25);return(0,S.jsxs)(`div`,{style:{height:`100%`,display:`flex`,flexDirection:`column`,alignItems:`center`,gap:t*.06,padding:t*.06},children:[(0,S.jsx)(I,{w:e*.3,h:4,strong:!0}),(0,S.jsx)(`div`,{style:{display:`flex`,gap:e*.06,justifyContent:`center`,flex:1,alignItems:`center`},children:Array.from({length:n},(t,n)=>(0,S.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,alignItems:`center`,gap:6},children:[(0,S.jsx)(Ne,{size:r}),(0,S.jsx)(I,{w:e*.12,h:3,strong:!0}),(0,S.jsx)(I,{w:e*.08,h:2})]},n))})]})}function zt({width:e,height:t}){let n=Math.max(2,Math.min(3,Math.floor(t/80)));return(0,S.jsxs)(`div`,{style:{height:`100%`,display:`flex`,flexDirection:`column`,alignItems:`center`,padding:e*.06,gap:t*.04},children:[(0,S.jsx)(I,{w:e*.5,h:Math.max(5,t*.04),strong:!0}),(0,S.jsx)(I,{w:e*.35,h:2}),(0,S.jsx)(`div`,{style:{width:`100%`,display:`flex`,flexDirection:`column`,gap:t*.03,marginTop:t*.04},children:Array.from({length:n},(n,r)=>(0,S.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:3},children:[(0,S.jsx)(I,{w:Math.min(60,e*.2),h:2}),(0,S.jsx)(Me,{w:`100%`,h:Math.min(32,t*.1),radius:4})]},r))}),(0,S.jsx)(Me,{w:`100%`,h:Math.min(36,t*.12),radius:6,style:{marginTop:t*.03,background:`var(--agd-bar)`}}),(0,S.jsx)(I,{w:e*.4,h:2})]})}function Bt({width:e,height:t}){return(0,S.jsxs)(`div`,{style:{height:`100%`,display:`flex`,flexDirection:`column`,padding:e*.04,gap:t*.03},children:[(0,S.jsx)(I,{w:e*.4,h:4,strong:!0}),(0,S.jsx)(I,{w:e*.6,h:2}),(0,S.jsxs)(`div`,{style:{display:`flex`,gap:6,marginTop:t*.03},children:[(0,S.jsxs)(`div`,{style:{flex:1,display:`flex`,flexDirection:`column`,gap:3},children:[(0,S.jsx)(I,{w:50,h:2}),(0,S.jsx)(Me,{w:`100%`,h:Math.min(28,t*.1),radius:4})]}),(0,S.jsxs)(`div`,{style:{flex:1,display:`flex`,flexDirection:`column`,gap:3},children:[(0,S.jsx)(I,{w:40,h:2}),(0,S.jsx)(Me,{w:`100%`,h:Math.min(28,t*.1),radius:4})]})]}),(0,S.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:3},children:[(0,S.jsx)(I,{w:50,h:2}),(0,S.jsx)(Me,{w:`100%`,h:Math.min(28,t*.1),radius:4})]}),(0,S.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:3,flex:1},children:[(0,S.jsx)(I,{w:60,h:2}),(0,S.jsx)(Me,{w:`100%`,h:`100%`,radius:4})]}),(0,S.jsx)(Me,{w:Math.min(120,e*.3),h:Math.min(30,t*.1),radius:6,style:{alignSelf:`flex-end`,background:`var(--agd-bar)`}})]})}var Vt={navigation:Pe,hero:Fe,sidebar:Ie,footer:L,modal:Le,card:Re,text:ze,image:Be,table:Ve,list:He,button:Ue,input:We,form:Ge,tabs:R,avatar:Ke,badge:qe,header:Je,section:Ye,grid:Xe,dropdown:Ze,toggle:Qe,search:$e,toast:et,progress:tt,chart:nt,video:z,tooltip:rt,breadcrumb:it,pagination:at,divider:B,accordion:ot,carousel:st,pricing:ct,testimonial:lt,cta:ut,alert:dt,banner:ft,stat:pt,stepper:mt,tag:ht,rating:gt,map:_t,timeline:vt,fileUpload:yt,codeBlock:bt,calendar:xt,notification:V,productCard:St,profile:Ct,drawer:wt,popover:Tt,logo:Et,faq:Dt,gallery:Ot,checkbox:kt,radio:At,slider:jt,datePicker:Mt,skeleton:Nt,chip:Pt,icon:Ft,spinner:It,feature:Lt,team:Rt,login:zt,contact:Bt};function Ht({type:e,width:t,height:n,text:r}){let i=Vt[e];return i?(0,S.jsx)(`div`,{style:{width:`100%`,height:`100%`,padding:8,position:`relative`,pointerEvents:`none`},children:(0,S.jsx)(i,{width:t,height:n,text:r})}):(0,S.jsx)(`div`,{style:{width:`100%`,height:`100%`,display:`flex`,alignItems:`center`,justifyContent:`center`},children:(0,S.jsx)(`span`,{style:{fontSize:10,fontWeight:600,color:`var(--agd-text-3)`,textTransform:`uppercase`,letterSpacing:`0.06em`,opacity:.5},children:e})})}var Ut=`svg[fill=none] {
  fill: none !important;
}
...
`,i.forEach((e,t)=>{let n=je[e.type]?.label||e.type;a+=`${t+1}. **${n}** \u2014 \`${Math.round(e.width)}\xD7${Math.round(e.height)}px\` at \`(${Math.round(e.x)}, ${Math.round(e.y)})\`
`}),a;let o=$n(t);a+=nr(o),a+=`### Components
`,i.forEach((e,t)=>{let n=je[e.type]?.label||e.type,i={x:e.x,y:e.y,width:e.width,height:e.height};a+=`${t+1}. **${n}** \u2014 \`${Math.round(e.width)}\xD7${Math.round(e.height)}px\` at \`(${Math.round(e.x)}, ${Math.round(e.y)})\`
`;let s=Jn(Wn(i),{includeLeftRight:r===`detailed`||r===`forensic`});for(let e of s)a+=`   - ${e}
`;let c=tr(i,o);c&&(a+=`   - CSS: ${c}
`)}),a+=`
### Layout Analysis
`;let s=[];for(let e of i){let t=s.find(t=>Math.abs(t.y-e.y)<30);t?t.items.push(e):s.push({y:e.y,items:[e]})}if(s.sort((e,t)=>e.y-t.y),s.forEach((e,n)=>{e.items.sort((e,t)=>e.x-t.x);let r=e.items.map(e=>je[e.type]?.label||e.type);if(e.items.length===1){let i=e.items[0].width>t.width*.8;a+=`- Row ${n+1} (y\u2248${Math.round(e.y)}): ${r[0]}${i?` — full width`:``}
`}else a+=`- Row ${n+1} (y\u2248${Math.round(e.y)}): ${r.join(` | `)} \u2014 ${e.items.length} items side by side
`}),r===`detailed`||r===`forensic`){a+=`
### Spacing & Gaps
`;for(let e=0;e<i.length-1;e++){let t=i[e],n=i[e+1],r=je[t.type]?.label||t.type,o=je[n.type]?.label||n.type,s=Math.round(n.y-(t.y+t.height)),c=Math.round(n.x-(t.x+t.width));Math.abs(t.y-n.y)<30?a+=`- ${r} \u2192 ${o}: \`${c}px\` horizontal gap
`:a+=`- ${r} \u2192 ${o}: \`${s}px\` vertical gap
`}if(r===`forensic`&&i.length>2){a+=`
### All Pairwise Gaps
`;for(let e=0;e<i.length;e++)for(let t=e+1;t<i.length;t++){let n=i[e],r=i[t],o=je[n.type]?.label||n.type,s=je[r.type]?.label||r.type,c=Math.round(r.y-(n.y+n.height)),l=Math.round(r.x-(n.x+n.width));a+=`- ${o} \u2194 ${s}: h=\`${l}px\` v=\`${c}px\`
`}}r===`forensic`&&(a+=`
### Z-Order (placement order)
`,e.forEach((e,t)=>{let n=je[e.type]?.label||e.type;a+=`${t}. ${n} at \`(${Math.round(e.x)}, ${Math.round(e.y)})\`
`}))}a+=`
...
`)}
    ...
    }`].join(``),document.head.appendChild(e)})();function Ki(e,t){let n=document.elementFromPoint(e,t);if(!n)return null;for(;n?.shadowRoot;){let r=n.shadowRoot.elementFromPoint(e,t);if(!r||r===n)break;n=r}return n}function qi(e){let t=e;for(;t&&t!==document.body;){let e=window.getComputedStyle(t).position;if(e===`fixed`||e===`sticky`)return!0;t=t.parentElement}return!1}function Ji(e){return e.status!==`resolved`&&e.status!==`dismissed`}function Yi(e){let t=hi(e),n=t.found?t:_i(e);if(n.found&&n.source)return gi(n.source,`path`)}function Xi({demoAnnotations:e,demoDelay:t=1e3,enableDemoMode:n=!1,onAnnotationAdd:r,onAnnotationDelete:i,onAnnotationUpdate:a,onAnnotationsClear:o,onCopy:s,onSubmit:c,copyToClipboard:l=!0,endpoint:u,sessionId:d,onSessionCreated:f,webhookUrl:p,className:m}={}){let[h,g]=(0,b.useState)(!1),[_,v]=(0,b.useState)([]),[y,C]=(0,b.useState)(!0),[w,T]=(0,b.useState)(()=>Ar()),[ee,te]=(0,b.useState)(!1),E=(0,b.useRef)(null);(0,b.useEffect)(()=>{let e=e=>{let t=E.current;t&&t.contains(e.target)&&e.stopPropagation()},t=[`mousedown`,`click`,`pointerdown`];return t.forEach(t=>document.body.addEventListener(t,e)),()=>{t.forEach(t=>document.body.removeEventListener(t,e))}},[]);let[ne,ie]=(0,b.useState)(!1),[k,ue]=(0,b.useState)(!1),[A,de]=(0,b.useState)(null),[j,fe]=(0,b.useState)({x:0,y:0}),[M,me]=(0,b.useState)(null),[he,ge]=(0,b.useState)(!1),[_e,N]=(0,b.useState)(`idle`),[be,Ce]=(0,b.useState)(!1),[Te,Ee]=(0,b.useState)(!1),[De,Oe]=(0,b.useState)(null),[Ae,je]=(0,b.useState)(null),[I,Me]=(0,b.useState)([]),[Ne,Pe]=(0,b.useState)(null),[Fe,Ie]=(0,b.useState)(null),[L,Le]=(0,b.useState)(null),[Re,ze]=(0,b.useState)(null),[Be,Ve]=(0,b.useState)([]),[He,Ue]=(0,b.useState)(0),[We,Ge]=(0,b.useState)(!1),[R,Ke]=(0,b.useState)(!1),[qe,Je]=(0,b.useState)(!1),[Ye,Xe]=(0,b.useState)(!1),[Ze,Qe]=(0,b.useState)(!1),[$e,et]=(0,b.useState)(`main`),[tt,nt]=(0,b.useState)(!1),[z,rt]=(0,b.useState)(!1),[it,at]=(0,b.useState)(!1),[B,ot]=(0,b.useState)([]),[st,ct]=(0,b.useState)(null),lt=(0,b.useRef)(!1),[ut,dt]=(0,b.useState)(!1),[ft,pt]=(0,b.useState)(!1),[mt,ht]=(0,b.useState)(1),[gt,_t]=(0,b.useState)(`new-page`),[vt,yt]=(0,b.useState)(``),[bt,xt]=(0,b.useState)(!1),[V,St]=(0,b.useState)(null),Ct=(0,b.useRef)(!1),wt=(0,b.useRef)({rearrange:null,placements:[]}),Tt=(0,b.useRef)({rearrange:null,placements:[]}),[Et,Dt]=(0,b.useState)(0),[Ot,kt]=(0,b.useState)(0),[At,jt]=(0,b.useState)(0),[Mt,Nt]=(0,b.useState)(0),Pt=(0,b.useRef)(new Set),Ft=(0,b.useRef)(new Set),It=(0,b.useRef)(null),Lt=(0,b.useRef)(),Rt=z&&h&&!it&&ut;(0,b.useEffect)(()=>{if(Rt){pt(!1);let e=ye(()=>{pt(!0)});return()=>cancelAnimationFrame(e)}else pt(!1)},[Rt]);let zt=(0,b.useRef)(new Map),Bt=(0,b.useRef)(new Map),Vt=(0,b.useRef)(),[Ht,Ut]=(0,b.useState)(!1),[Wt,Gt]=(0,b.useState)([]),Kt=(0,b.useRef)(Wt);Kt.current=Wt;let[qt,Jt]=(0,b.useState)(null),Xt=(0,b.useRef)(null);(0,b.useRef)(!1),(0,b.useRef)([]),(0,b.useRef)(0),(0,b.useRef)(null),(0,b.useRef)(null),(0,b.useRef)(1);let[U,W]=(0,b.useState)(!1),Zt=(0,b.useRef)(null),[Qt,$t]=(0,b.useState)([]),tn=(0,b.useRef)({cmd:!1,shift:!1}),rn=()=>{nt(!0)},ln=()=>{nt(!1)},un=()=>{U||(Zt.current=P(()=>W(!0),850))},dn=()=>{Zt.current&&=(clearTimeout(Zt.current),null),W(!1),ln()};(0,b.useEffect)(()=>()=>{Zt.current&&clearTimeout(Zt.current)},[]);let[G,fn]=(0,b.useState)(()=>{try{let e=JSON.parse(localStorage.getItem(`feedback-toolbar-settings`)??``);return{...Ui,...e,annotationColorId:Gi.find(t=>t.id===e.annotationColorId)?e.annotationColorId:Ui.annotationColorId}}catch{return Ui}}),[mn,yn]=(0,b.useState)(!0),[bn,xn]=(0,b.useState)(!1),Sn=()=>{E.current?.classList.add(q.disableTransitions),yn(e=>!e),ye(()=>{E.current?.classList.remove(q.disableTransitions)})},[Cn,wn]=(0,b.useState)(d??null),Tn=(0,b.useRef)(!1),[En,Dn]=(0,b.useState)(u?`connecting`:`disconnected`),[On,An]=(0,b.useState)(null),[jn,Mn]=(0,b.useState)(!1),[Nn,Pn]=(0,b.useState)(null),Fn=(0,b.useRef)(!1),[In,Ln]=(0,b.useState)(new Set),[Rn,Bn]=(0,b.useState)(new Set),[Vn,Hn]=(0,b.useState)(!1),[Un,Wn]=(0,b.useState)(!1),[Gn,Kn]=(0,b.useState)(!1),qn=(0,b.useRef)(null),Jn=(0,b.useRef)(null),Yn=(0,b.useRef)(null),Xn=(0,b.useRef)(null),Zn=(0,b.useRef)(!1),Qn=(0,b.useRef)(0),$n=(0,b.useRef)(null),er=(0,b.useRef)(null),tr=(0,b.useRef)(null),nr=(0,b.useRef)(null),rr=(0,b.useRef)(null),K=typeof window<`u`?window.location.pathname:`/`;(0,b.useEffect)(()=>{if(Ye)Qe(!0);else{nt(!1),et(`main`);let e=P(()=>Qe(!1),0);return()=>clearTimeout(e)}},[Ye]);let or=h&&y&&!z;(0,b.useEffect)(()=>{if(or){ue(!1),ie(!0),Ln(new Set);let e=P(()=>{Ln(e=>{let t=new Set(e);return _.forEach(e=>t.add(e.id)),t})},350);return()=>clearTimeout(e)}else if(ne){ue(!0);let e=P(()=>{ie(!1),ue(!1)},250);return()=>clearTimeout(e)}},[or]),(0,b.useEffect)(()=>{Ke(!0),Ue(window.scrollY),v(cr(K).filter(Ji)),Hi||(xn(!0),Hi=!0,P(()=>xn(!1),750));try{let e=localStorage.getItem(`feedback-toolbar-theme`);e!==null&&yn(e===`dark`)}catch{}try{let e=localStorage.getItem(`feedback-toolbar-position`);if(e){let t=JSON.parse(e);typeof t.x==`number`&&typeof t.y==`number`&&An(t)}}catch{}},[K]),(0,b.useEffect)(()=>{R&&localStorage.setItem(`feedback-toolbar-settings`,JSON.stringify(G))},[G,R]),(0,b.useEffect)(()=>{R&&localStorage.setItem(`feedback-toolbar-theme`,mn?`dark`:`light`)},[mn,R]);let fr=(0,b.useRef)(!1);(0,b.useEffect)(()=>{let e=fr.current;fr.current=jn,e&&!jn&&On&&R&&localStorage.setItem(`feedback-toolbar-position`,JSON.stringify(On))},[jn,On,R]),(0,b.useEffect)(()=>{!u||!R||Tn.current||(Tn.current=!0,Dn(`connecting`),(async()=>{try{let e=Er(K),t=d||e,n=!1;if(t)try{let e=await Nr(u,t);wn(e.id),Dn(`connected`),Dr(K,e.id),n=!0;let r=cr(K),i=new Set(e.annotations.map(e=>e.id)),a=r.filter(e=>!i.has(e.id));if(a.length>0){let t=`${typeof window<`u`?window.location.origin:``}${K}`,n=(await Promise.allSettled(a.map(n=>Pr(u,e.id,{...n,sessionId:e.id,url:t})))).map((e,t)=>e.status===`fulfilled`?e.value:(console.warn(`[Agentation] Failed to sync annotation:`,e.reason),a[t])),r=[...e.annotations,...n];v(r.filter(Ji)),dr(K,r.filter(Ji),e.id)}else v(e.annotations.filter(Ji)),dr(K,e.annotations.filter(Ji),e.id)}catch(e){console.warn(`[Agentation] Could not join session, creating new:`,e),Or(K)}if(!n){let e=await Mr(u,typeof window<`u`?window.location.href:`/`);wn(e.id),Dn(`connected`),Dr(K,e.id),f?.(e.id);let t=ur(),n=typeof window<`u`?window.location.origin:``,r=[];for(let[i,a]of t){let t=a.filter(e=>!e._syncedTo);if(t.length===0)continue;let o=`${n}${i}`,s=i===K;r.push((async()=>{try{let n=s?e:await Mr(u,o),r=(await Promise.allSettled(t.map(e=>Pr(u,n.id,{...e,sessionId:n.id,url:o})))).map((e,n)=>e.status===`fulfilled`?e.value:(console.warn(`[Agentation] Failed to sync annotation:`,e.reason),t[n])).filter(Ji);if(dr(i,r,n.id),s){let e=new Set(t.map(e=>e.id));v(t=>{let n=t.filter(t=>!e.has(t.id));return[...r,...n]})}}catch(e){console.warn(`[Agentation] Failed to sync annotations for ${i}:`,e)}})())}await Promise.allSettled(r)}}catch(e){Dn(`disconnected`),console.warn(`[Agentation] Failed to initialize session, using local storage:`,e)}})())},[u,d,R,f,K]),(0,b.useEffect)(()=>{if(!u||!R)return;let e=async()=>{try{(await fetch(`${u}/health`)).ok?Dn(`connected`):Dn(`disconnected`)}catch{Dn(`disconnected`)}};e();let t=ve(e,1e4);return()=>clearInterval(t)},[u,R]),(0,b.useEffect)(()=>{if(!u||!R||!Cn)return;let e=new EventSource(`${u}/sessions/${Cn}/events`),t=[`resolved`,`dismissed`],n=e=>{try{let n=JSON.parse(e.data);if(t.includes(n.payload?.status)){let e=n.payload.id,t=n.payload.kind;if(t===`placement`){for(let[t,n]of zt.current)if(n===e){zt.current.delete(t),ot(e=>e.filter(e=>e.id!==t));break}}else if(t===`rearrange`){for(let[t,n]of Bt.current)if(n===e){Bt.current.delete(t),St(e=>{if(!e)return null;let n=e.sections.filter(e=>e.id!==t);return n.length===0?null:{...e,sections:n}});break}}else Bn(t=>new Set(t).add(e)),P(()=>{v(t=>t.filter(t=>t.id!==e)),Bn(t=>{let n=new Set(t);return n.delete(e),n})},150)}}catch{}};return e.addEventListener(`annotation.updated`,n),()=>{e.removeEventListener(`annotation.updated`,n),e.close()}},[u,R,Cn]),(0,b.useEffect)(()=>{if(!u||!R)return;let e=er.current===`disconnected`,t=En===`connected`;er.current=En,e&&t&&(async()=>{try{let e=cr(K);if(e.length===0)return;let t=`${typeof window<`u`?window.location.origin:``}${K}`,n=Cn,r=[];if(n)try{r=(await Nr(u,n)).annotations}catch{n=null}n||(n=(await Mr(u,t)).id,wn(n),Dr(K,n));let i=new Set(r.map(e=>e.id)),a=e.filter(e=>!i.has(e.id));if(a.length>0){let e=(await Promise.allSettled(a.map(e=>Pr(u,n,{...e,sessionId:n,url:t})))).map((e,t)=>e.status===`fulfilled`?e.value:(console.warn(`[Agentation] Failed to sync annotation on reconnect:`,e.reason),a[t])),i=[...r,...e].filter(Ji);v(i),dr(K,i,n)}}catch(e){console.warn(`[Agentation] Failed to sync on reconnect:`,e)}})()},[En,u,R,Cn,K]);let gr=(0,b.useCallback)(()=>{ee||(te(!0),Xe(!1),g(!1),P(()=>{jr(!0),T(!0),te(!1)},400))},[ee]);(0,b.useEffect)(()=>{if(!n||!R||!e||e.length===0||_.length>0)return;let r=[];return r.push(P(()=>{g(!0)},t-200)),e.forEach((e,n)=>{let i=t+n*300;r.push(P(()=>{let t=document.querySelector(e.selector);if(!t)return;let r=t.getBoundingClientRect(),{name:i,path:a}=an(t),o={id:`demo-${Date.now()}-${n}`,x:(r.left+r.width/2)/window.innerWidth*100,y:r.top+r.height/2+window.scrollY,comment:e.comment,element:i,elementPath:a,timestamp:Date.now(),selectedText:e.selectedText,boundingBox:{x:r.left,y:r.top+window.scrollY,width:r.width,height:r.height},nearbyText:on(t),cssClasses:cn(t)};v(e=>[...e,o])},i))}),()=>{r.forEach(clearTimeout)}},[n,R,e,t]),(0,b.useEffect)(()=>{let e=()=>{Ue(window.scrollY),Ge(!0),rr.current&&clearTimeout(rr.current),rr.current=P(()=>{Ge(!1)},150)};return window.addEventListener(`scroll`,e,{passive:!0}),()=>{window.removeEventListener(`scroll`,e),rr.current&&clearTimeout(rr.current)}},[]),(0,b.useEffect)(()=>{R&&_.length>0?Cn?dr(K,_,Cn):lr(K,_):R&&_.length===0&&localStorage.removeItem(sr(K))},[_,K,R,Cn]),(0,b.useEffect)(()=>{if(R&&!lt.current){lt.current=!0;let e=pr(K);e.length>0&&ot(e)}},[R,K]),(0,b.useEffect)(()=>{R&&lt.current&&!ut&&(B.length>0?mr(K,B):hr(K))},[B,K,R,ut]),(0,b.useEffect)(()=>{if(R&&!Ct.current){Ct.current=!0;let e=_r(K);e&&St({...e,sections:e.sections.map(e=>({...e,currentRect:e.currentRect??{...e.originalRect}}))})}},[R,K]),(0,b.useEffect)(()=>{R&&Ct.current&&!ut&&(V?vr(K,V):yr(K))},[V,K,R,ut]);let br=(0,b.useRef)(!1);(0,b.useEffect)(()=>{if(R&&!br.current){br.current=!0;let e=xr(K);e&&(Tt.current={rearrange:e.rearrange,placements:e.placements||[]},e.purpose&&yt(e.purpose))}},[R,K]),(0,b.useEffect)(()=>{if(!R||!br.current)return;let e=Tt.current;ut?(V?.sections?.length??0)>0||B.length>0||vt?Sr(K,{rearrange:V,placements:B,purpose:vt}):Cr(K):(e.rearrange?.sections?.length??0)>0||e.placements.length>0||vt?Sr(K,{rearrange:e.rearrange,placements:e.placements,purpose:vt}):Cr(K)},[V,B,vt,ut,K,R]),(0,b.useEffect)(()=>{z&&!V&&St({sections:[],originalOrder:[],detectedAt:Date.now()})},[z,V]),(0,b.useEffect)(()=>{if(!u||!Cn)return;let e=zt.current,t=new Set(B.map(e=>e.id));for(let t of B){if(e.has(t.id))continue;e.set(t.id,``);let n=typeof window<`u`?window.location.pathname+window.location.search+window.location.hash:K;Pr(u,Cn,{id:t.id,x:t.x/window.innerWidth*100,y:t.y,comment:`Place ${t.type} at (${Math.round(t.x)}, ${Math.round(t.y)}), ${t.width}\xD7${t.height}px${t.text?` \u2014 "${t.text}"`:``}`,element:`[design:${t.type}]`,elementPath:`[placement]`,timestamp:t.timestamp,url:n,intent:`change`,severity:`important`,kind:`placement`,placement:{componentType:t.type,width:t.width,height:t.height,scrollY:t.scrollY,text:t.text}}).then(n=>{e.has(t.id)&&e.set(t.id,n.id)}).catch(n=>{console.warn(`[Agentation] Failed to sync placement annotation:`,n),e.delete(t.id)})}for(let[n,r]of e)t.has(n)||(e.delete(n),r&&Ir(u,r).catch(()=>{}))},[B,u,Cn,K]),(0,b.useEffect)(()=>{if(!(!u||!Cn))return Vt.current&&clearTimeout(Vt.current),Vt.current=P(()=>{let e=Bt.current;if(!V||V.sections.length===0){for(let[,t]of e)t&&Ir(u,t).catch(()=>{});e.clear();return}let t=new Set(V.sections.map(e=>e.id)),n=typeof window<`u`?window.location.pathname+window.location.search+window.location.hash:K;for(let t of V.sections){let r=t.originalRect,i=t.currentRect;if(!(Math.abs(r.x-i.x)>1||Math.abs(r.y-i.y)>1||Math.abs(r.width-i.width)>1||Math.abs(r.height-i.height)>1)){let n=e.get(t.id);n&&(e.delete(t.id),Ir(u,n).catch(()=>{}));continue}let a=e.get(t.id);a?Fr(u,a,{comment:`Move ${t.label} section (${t.tagName}) \u2014 from (${Math.round(r.x)},${Math.round(r.y)}) ${Math.round(r.width)}\xD7${Math.round(r.height)} to (${Math.round(i.x)},${Math.round(i.y)}) ${Math.round(i.width)}\xD7${Math.round(i.height)}`}).catch(e=>{console.warn(`[Agentation] Failed to update rearrange annotation:`,e)}):(e.set(t.id,``),Pr(u,Cn,{id:t.id,x:i.x/window.innerWidth*100,y:i.y,comment:`Move ${t.label} section (${t.tagName}) \u2014 from (${Math.round(r.x)},${Math.round(r.y)}) ${Math.round(r.width)}\xD7${Math.round(r.height)} to (${Math.round(i.x)},${Math.round(i.y)}) ${Math.round(i.width)}\xD7${Math.round(i.height)}`,element:t.selector,elementPath:`[rearrange]`,timestamp:Date.now(),url:n,intent:`change`,severity:`important`,kind:`rearrange`,rearrange:{selector:t.selector,label:t.label,tagName:t.tagName,originalRect:r,currentRect:i}}).then(n=>{e.has(t.id)&&e.set(t.id,n.id)}).catch(n=>{console.warn(`[Agentation] Failed to sync rearrange annotation:`,n),e.delete(t.id)}))}for(let[n,r]of e)t.has(n)||(e.delete(n),r&&Ir(u,r).catch(()=>{}))},300),()=>{Vt.current&&clearTimeout(Vt.current)}},[V,u,Cn,K]);let wr=(0,b.useRef)(new Map);(0,b.useLayoutEffect)(()=>{let e=V?.sections??[],t=new Set;if((z||it)&&h)for(let n of e){t.add(n.id);try{let e=document.querySelector(n.selector);if(!e)continue;if(!wr.current.has(n.id)){let t={transform:e.style.transform,transformOrigin:e.style.transformOrigin,opacity:e.style.opacity,position:e.style.position,zIndex:e.style.zIndex,display:e.style.display},r=[],i=e.parentElement;for(;i&&i!==document.body;){let e=getComputedStyle(i);(e.overflow!==`visible`||e.overflowX!==`visible`||e.overflowY!==`visible`)&&(r.push({el:i,overflow:i.style.overflow}),i.style.overflow=`visible`),i=i.parentElement}getComputedStyle(e).display===`inline`&&(e.style.display=`inline-block`),wr.current.set(n.id,{el:e,origStyles:t,ancestors:r}),e.style.transformOrigin=`top left`,e.style.zIndex=`9999`}}catch{}}for(let[e,n]of wr.current)if(!t.has(e)){let{el:t,origStyles:r,ancestors:i}=n;t.style.transition=`transform 0.4s cubic-bezier(0.22, 1, 0.36, 1), opacity 0.4s cubic-bezier(0.22, 1, 0.36, 1)`,t.style.transform=r.transform,t.style.transformOrigin=r.transformOrigin,t.style.opacity=r.opacity,t.style.position=r.position,t.style.zIndex=r.zIndex,wr.current.delete(e),P(()=>{t.style.transition=``,t.style.display=r.display;for(let e of i)e.el.style.overflow=e.overflow},450)}},[V,z,it,h]),(0,b.useEffect)(()=>()=>{for(let[,e]of wr.current){let{el:t,origStyles:n,ancestors:r}=e;t.style.transition=`transform 0.4s cubic-bezier(0.22, 1, 0.36, 1), opacity 0.4s cubic-bezier(0.22, 1, 0.36, 1)`,t.style.transform=n.transform,t.style.transformOrigin=n.transformOrigin,t.style.opacity=n.opacity,t.style.position=n.position,t.style.zIndex=n.zIndex,P(()=>{t.style.transition=``,t.style.display=n.display;for(let e of r)e.el.style.overflow=e.overflow},450)}wr.current.clear()},[]);let Tr=(0,b.useCallback)(()=>{at(!0),rt(!1),ct(null),clearTimeout(Lt.current),Lt.current=P(()=>{at(!1)},300)},[]),kr=(0,b.useCallback)(()=>{z&&(at(!0),rt(!1),ct(null),clearTimeout(Lt.current),Lt.current=P(()=>{at(!1)},300)),g(!1)},[z]),Lr=(0,b.useCallback)(()=>{qe||(xe(),Je(!0))},[qe]),Rr=(0,b.useCallback)(()=>{qe&&(Se(),Je(!1))},[qe]),zr=(0,b.useCallback)(()=>{qe?Rr():Lr()},[qe,Lr,Rr]),Br=(0,b.useCallback)(()=>{if(Qt.length===0)return;let e=Qt[0],t=e.element,n=Qt.length>1,r=Qt.map(e=>e.element.getBoundingClientRect());if(n){let e={left:Math.min(...r.map(e=>e.left)),top:Math.min(...r.map(e=>e.top)),right:Math.max(...r.map(e=>e.right)),bottom:Math.max(...r.map(e=>e.bottom))},n=Qt.slice(0,5).map(e=>e.name).join(`, `),i=Qt.length>5?` +${Qt.length-5} more`:``,a=r.map(e=>({x:e.left,y:e.top+window.scrollY,width:e.width,height:e.height})),o=Qt[Qt.length-1].element,s=r[r.length-1],c=s.left+s.width/2,l=s.top+s.height/2,u=qi(o);me({x:c/window.innerWidth*100,y:u?l:l+window.scrollY,clientY:l,element:`${Qt.length} elements: ${n}${i}`,elementPath:`multi-select`,boundingBox:{x:e.left,y:e.top+window.scrollY,width:e.right-e.left,height:e.bottom-e.top},isMultiSelect:!0,isFixed:u,elementBoundingBoxes:a,multiSelectElements:Qt.map(e=>e.element),targetElement:o,fullPath:vn(t),accessibility:_n(t),computedStyles:hn(t),computedStylesObj:pn(t),nearbyElements:sn(t),cssClasses:cn(t),nearbyText:on(t),sourceFile:Yi(t)})}else{let n=r[0],i=qi(t);me({x:n.left/window.innerWidth*100,y:i?n.top:n.top+window.scrollY,clientY:n.top,element:e.name,elementPath:e.path,boundingBox:{x:n.left,y:i?n.top:n.top+window.scrollY,width:n.width,height:n.height},isFixed:i,fullPath:vn(t),accessibility:_n(t),computedStyles:hn(t),computedStylesObj:pn(t),nearbyElements:sn(t),cssClasses:cn(t),nearbyText:on(t),reactComponents:e.reactComponents,sourceFile:Yi(t)})}$t([]),de(null)},[Qt]);(0,b.useEffect)(()=>{h||(me(null),Le(null),ze(null),Ve([]),de(null),Xe(!1),$t([]),tn.current={cmd:!1,shift:!1},qe&&Rr())},[h,qe,Rr]),(0,b.useEffect)(()=>()=>{Se()},[]),(0,b.useEffect)(()=>{if(!h)return;let e=`p.span.h1.h2.h3.h4.h5.h6.li.td.th.label.blockquote.figcaption.caption.legend.dt.dd.pre.code.em.strong.b.i.u.s.a.time.address.cite.q.abbr.dfn.mark.small.sub.sup.[contenteditable]`.split(`.`).join(`, `),t=`:not([data-agentation-root]):not([data-agentation-root] *)`,n=document.createElement(`style`);return n.id=`feedback-cursor-styles`,n.textContent=`
      body ${t} {
        cursor: crosshair !important;
      }
    ...
    `,document.head.appendChild(n),()=>{let e=document.getElementById(`feedback-cursor-styles`);e&&e.remove()}},[h]),(0,b.useEffect)(()=>{if(qt!==null&&h)return document.documentElement.setAttribute(`data-drawing-hover`,``),()=>document.documentElement.removeAttribute(`data-drawing-hover`)},[qt,h]),(0,b.useEffect)(()=>{if(!h||M||Ht||z)return;let e=e=>{if(nn(e.composedPath()[0]||e.target,`[data-feedback-toolbar]`)){de(null);return}let t=Ki(e.clientX,e.clientY);if(!t||nn(t,`[data-feedback-toolbar]`)){de(null);return}let{name:n,elementName:r,path:i,reactComponents:a}=Vi(t,`off`);de({element:n,elementName:r,elementPath:i,rect:t.getBoundingClientRect(),reactComponents:a}),fe({x:e.clientX,y:e.clientY})};return document.addEventListener(`mousemove`,e),()=>document.removeEventListener(`mousemove`,e)},[h,M,Ht,z,`off`,Wt]);let Vr=(0,b.useCallback)(e=>{if(Le(e),Oe(null),je(null),Me([]),e.elementBoundingBoxes?.length){let t=[];for(let n of e.elementBoundingBoxes){let e=Ki(n.x+n.width/2,n.y+n.height/2-window.scrollY);e&&t.push(e)}Ve(t),ze(null)}else if(e.boundingBox){let t=e.boundingBox,n=Ki(t.x+t.width/2,e.isFixed?t.y+t.height/2:t.y+t.height/2-window.scrollY);if(n){let e=n.getBoundingClientRect(),r=e.width/t.width,i=e.height/t.height;ze(r<.5||i<.5?null:n)}else ze(null);Ve([])}else ze(null),Ve([])},[]);(0,b.useEffect)(()=>{if(!h||Ht||z)return;let e=e=>{if(Zn.current){Zn.current=!1;return}let t=e.composedPath()[0]||e.target;if(nn(t,`[data-feedback-toolbar]`)||nn(t,`[data-annotation-popup]`)||nn(t,`[data-annotation-marker]`))return;if(e.metaKey&&e.shiftKey&&!M&&!L){e.preventDefault(),e.stopPropagation();let t=Ki(e.clientX,e.clientY);if(!t)return;let n=t.getBoundingClientRect(),{name:r,path:i,reactComponents:a}=Vi(t,`off`),o=Qt.findIndex(e=>e.element===t);$t(o>=0?e=>e.filter((e,t)=>t!==o):e=>[...e,{element:t,rect:n,name:r,path:i,reactComponents:a??void 0}]);return}let n=nn(t,`button, a, input, select, textarea, [role='button'], [onclick]`);if(G.blockInteractions&&n&&(e.preventDefault(),e.stopPropagation()),M){if(n&&!G.blockInteractions)return;e.preventDefault(),tr.current?.shake();return}if(L){if(n&&!G.blockInteractions)return;e.preventDefault(),nr.current?.shake();return}e.preventDefault();let r=Ki(e.clientX,e.clientY);if(!r)return;let{name:i,path:a,reactComponents:o}=Vi(r,`off`),s=r.getBoundingClientRect(),c=e.clientX/window.innerWidth*100,l=qi(r),u=l?e.clientY:e.clientY+window.scrollY,d=window.getSelection(),f;d&&d.toString().trim().length>0&&(f=d.toString().trim().slice(0,500));let p=pn(r),m=hn(r);me({x:c,y:u,clientY:e.clientY,element:i,elementPath:a,selectedText:f,boundingBox:{x:s.left,y:l?s.top:s.top+window.scrollY,width:s.width,height:s.height},nearbyText:on(r),cssClasses:cn(r),isFixed:l,fullPath:vn(r),accessibility:_n(r),computedStyles:m,computedStylesObj:p,nearbyElements:sn(r),reactComponents:o??void 0,sourceFile:Yi(r),targetElement:r}),de(null)};return document.addEventListener(`click`,e,!0),()=>document.removeEventListener(`click`,e,!0)},[h,Ht,z,M,L,G.blockInteractions,`off`,Qt]),(0,b.useEffect)(()=>{if(!h)return;let e=e=>{e.key===`Meta`&&(tn.current.cmd=!0),e.key===`Shift`&&(tn.current.shift=!0)},t=e=>{let t=tn.current.cmd&&tn.current.shift;e.key===`Meta`&&(tn.current.cmd=!1),e.key===`Shift`&&(tn.current.shift=!1);let n=tn.current.cmd&&tn.current.shift;t&&!n&&Qt.length>0&&Br()},n=()=>{tn.current={cmd:!1,shift:!1},$t([])};return document.addEventListener(`keydown`,e),document.addEventListener(`keyup`,t),window.addEventListener(`blur`,n),()=>{document.removeEventListener(`keydown`,e),document.removeEventListener(`keyup`,t),window.removeEventListener(`blur`,n)}},[h,Qt,Br]),(0,b.useEffect)(()=>{if(!h||M||Ht||z)return;let e=e=>{let t=e.composedPath()[0]||e.target;nn(t,`[data-feedback-toolbar]`)||nn(t,`[data-annotation-marker]`)||nn(t,`[data-annotation-popup]`)||new Set(`P.SPAN.H1.H2.H3.H4.H5.H6.LI.TD.TH.LABEL.BLOCKQUOTE.FIGCAPTION.CAPTION.LEGEND.DT.DD.PRE.CODE.EM.STRONG.B.I.U.S.A.TIME.ADDRESS.CITE.Q.ABBR.DFN.MARK.SMALL.SUB.SUP`.split(`.`)).has(t.tagName)||t.isContentEditable||(e.preventDefault(),qn.current={x:e.clientX,y:e.clientY})};return document.addEventListener(`mousedown`,e),()=>document.removeEventListener(`mousedown`,e)},[h,M,Ht,z]),(0,b.useEffect)(()=>{if(!h||M)return;let e=e=>{if(!qn.current)return;let t=e.clientX-qn.current.x,n=e.clientY-qn.current.y,r=t*t+n*n;if(!Gn&&r>=64&&(Jn.current=qn.current,Kn(!0),e.preventDefault()),(Gn||r>=64)&&Jn.current){if(Yn.current){let t=Math.min(Jn.current.x,e.clientX),n=Math.min(Jn.current.y,e.clientY),r=Math.abs(e.clientX-Jn.current.x),i=Math.abs(e.clientY-Jn.current.y);Yn.current.style.transform=`translate(${t}px, ${n}px)`,Yn.current.style.width=`${r}px`,Yn.current.style.height=`${i}px`}let t=Date.now();if(t-Qn.current<50)return;Qn.current=t;let n=Jn.current.x,r=Jn.current.y,i=Math.min(n,e.clientX),a=Math.min(r,e.clientY),o=Math.max(n,e.clientX),s=Math.max(r,e.clientY),c=(i+o)/2,l=(a+s)/2,u=new Set,d=[[i,a],[o,a],[i,s],[o,s],[c,l],[c,a],[c,s],[i,l],[o,l]];for(let[e,t]of d){let n=document.elementsFromPoint(e,t);for(let e of n)e instanceof HTMLElement&&u.add(e)}let f=document.querySelectorAll(`button, a, input, img, p, h1, h2, h3, h4, h5, h6, li, label, td, th, div, span, section, article, aside, nav`);for(let e of f)if(e instanceof HTMLElement){let t=e.getBoundingClientRect(),n=t.left+t.width/2,r=t.top+t.height/2,c=n>=i&&n<=o&&r>=a&&r<=s,l=Math.min(t.right,o)-Math.max(t.left,i),d=Math.min(t.bottom,s)-Math.max(t.top,a),f=l>0&&d>0?l*d:0,p=t.width*t.height,m=p>0?f/p:0;(c||m>.5)&&u.add(e)}let p=[],m=new Set([`BUTTON`,`A`,`INPUT`,`IMG`,`P`,`H1`,`H2`,`H3`,`H4`,`H5`,`H6`,`LI`,`LABEL`,`TD`,`TH`,`SECTION`,`ARTICLE`,`ASIDE`,`NAV`]);for(let e of u){if(nn(e,`[data-feedback-toolbar]`)||nn(e,`[data-annotation-marker]`))continue;let t=e.getBoundingClientRect();if(!(t.width>window.innerWidth*.8&&t.height>window.innerHeight*.5)&&!(t.width<10||t.height<10)&&t.left<o&&t.right>i&&t.top<s&&t.bottom>a){let n=e.tagName,r=m.has(n);if(!r&&(n===`DIV`||n===`SPAN`)){let t=e.textContent&&e.textContent.trim().length>0,n=e.onclick!==null||e.getAttribute(`role`)===`button`||e.getAttribute(`role`)===`link`||e.classList.contains(`clickable`)||e.hasAttribute(`data-clickable`);(t||n)&&!e.querySelector(`p, h1, h2, h3, h4, h5, h6, button, a`)&&(r=!0)}if(r){let e=!1;for(let n of p)if(n.left<=t.left&&n.right>=t.right&&n.top<=t.top&&n.bottom>=t.bottom){e=!0;break}e||p.push(t)}}}if(Xn.current){let e=Xn.current;for(;e.children.length>p.length;)e.removeChild(e.lastChild);p.forEach((t,n)=>{let r=e.children[n];r||(r=document.createElement(`div`),r.className=q.selectedElementHighlight,e.appendChild(r)),r.style.transform=`translate(${t.left}px, ${t.top}px)`,r.style.width=`${t.width}px`,r.style.height=`${t.height}px`})}}};return document.addEventListener(`mousemove`,e,{passive:!0}),()=>document.removeEventListener(`mousemove`,e)},[h,M,Gn,8]),(0,b.useEffect)(()=>{if(!h)return;let e=e=>{let t=Gn,n=Jn.current;if(Gn&&n){Zn.current=!0;let t=Math.min(n.x,e.clientX),r=Math.min(n.y,e.clientY),i=Math.max(n.x,e.clientX),a=Math.max(n.y,e.clientY),o=[];document.querySelectorAll(`button, a, input, img, p, h1, h2, h3, h4, h5, h6, li, label, td, th`).forEach(e=>{if(!(e instanceof HTMLElement)||nn(e,`[data-feedback-toolbar]`)||nn(e,`[data-annotation-marker]`))return;let n=e.getBoundingClientRect();n.width>window.innerWidth*.8&&n.height>window.innerHeight*.5||n.width<10||n.height<10||n.left<i&&n.right>t&&n.top<a&&n.bottom>r&&o.push({element:e,rect:n})});let s=o.filter(({element:e})=>!o.some(({element:t})=>t!==e&&e.contains(t))),c=e.clientX/window.innerWidth*100,l=e.clientY+window.scrollY;if(s.length>0){let t=s.reduce((e,{rect:t})=>({left:Math.min(e.left,t.left),top:Math.min(e.top,t.top),right:Math.max(e.right,t.right),bottom:Math.max(e.bottom,t.bottom)}),{left:1/0,top:1/0,right:-1/0,bottom:-1/0}),n=s.slice(0,5).map(({element:e})=>an(e).name).join(`, `),r=s.length>5?` +${s.length-5} more`:``,i=s[0].element,a=pn(i),o=hn(i);me({x:c,y:l,clientY:e.clientY,element:`${s.length} elements: ${n}${r}`,elementPath:`multi-select`,boundingBox:{x:t.left,y:t.top+window.scrollY,width:t.right-t.left,height:t.bottom-t.top},isMultiSelect:!0,fullPath:vn(i),accessibility:_n(i),computedStyles:o,computedStylesObj:a,nearbyElements:sn(i),cssClasses:cn(i),nearbyText:on(i),sourceFile:Yi(i)})}else{let n=Math.abs(i-t),o=Math.abs(a-r);n>20&&o>20&&me({x:c,y:l,clientY:e.clientY,element:`Area selection`,elementPath:`region at (${Math.round(t)}, ${Math.round(r)})`,boundingBox:{x:t,y:r+window.scrollY,width:n,height:o},isMultiSelect:!0})}de(null)}else t&&(Zn.current=!0);qn.current=null,Jn.current=null,Kn(!1),Xn.current&&(Xn.current.innerHTML=``)};return document.addEventListener(`mouseup`,e),()=>document.removeEventListener(`mouseup`,e)},[h,Gn]);let Hr=(0,b.useCallback)(async(e,t,n)=>{let r=G.webhookUrl||p;if(!r||!G.webhooksEnabled&&!n)return!1;try{return(await fetch(r,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({event:e,timestamp:Date.now(),url:typeof window<`u`?window.location.href:void 0,...t})})).ok}catch(e){return console.warn(`[Agentation] Webhook failed:`,e),!1}},[p,G.webhookUrl,G.webhooksEnabled]),Ur=(0,b.useCallback)(e=>{if(!M)return;let t={id:Date.now().toString(),x:M.x,y:M.y,comment:e,element:M.element,elementPath:M.elementPath,timestamp:Date.now(),selectedText:M.selectedText,boundingBox:M.boundingBox,nearbyText:M.nearbyText,cssClasses:M.cssClasses,isMultiSelect:M.isMultiSelect,isFixed:M.isFixed,fullPath:M.fullPath,accessibility:M.accessibility,computedStyles:M.computedStyles,nearbyElements:M.nearbyElements,reactComponents:M.reactComponents,sourceFile:M.sourceFile,elementBoundingBoxes:M.elementBoundingBoxes,...u&&Cn?{sessionId:Cn,url:typeof window<`u`?window.location.href:void 0,status:`pending`}:{}};v(e=>[...e,t]),$n.current=t.id,P(()=>{$n.current=null},300),P(()=>{Ln(e=>new Set(e).add(t.id))},250),r?.(t),Hr(`annotation.add`,{annotation:t}),Hn(!0),P(()=>{me(null),Hn(!1)},150),window.getSelection()?.removeAllRanges(),u&&Cn&&Pr(u,Cn,t).then(e=>{e.id!==t.id&&(v(n=>n.map(n=>n.id===t.id?{...n,id:e.id}:n)),Ln(n=>{let r=new Set(n);return r.delete(t.id),r.add(e.id),r}))}).catch(e=>{console.warn(`[Agentation] Failed to sync annotation:`,e)})},[M,r,Hr,u,Cn]),Wr=(0,b.useCallback)(()=>{Hn(!0),P(()=>{me(null),Hn(!1)},150)},[]),Gr=(0,b.useCallback)(e=>{let t=_.findIndex(t=>t.id===e),n=_[t];L?.id===e&&(Wn(!0),P(()=>{Le(null),ze(null),Ve([]),Wn(!1)},150)),Pe(e),Bn(t=>new Set(t).add(e)),n&&(i?.(n),Hr(`annotation.delete`,{annotation:n})),u&&Ir(u,e).catch(e=>{console.warn(`[Agentation] Failed to delete annotation from server:`,e)}),P(()=>{v(t=>t.filter(t=>t.id!==e)),Bn(t=>{let n=new Set(t);return n.delete(e),n}),Pe(null),t<_.length-1&&(Ie(t),P(()=>Ie(null),200))},150)},[_,L,i,Hr,u]),Kr=(0,b.useCallback)(e=>{if(!e){Oe(null),je(null),Me([]);return}if(Oe(e.id),e.elementBoundingBoxes?.length){let t=[];for(let n of e.elementBoundingBoxes){let e=n.x+n.width/2,r=n.y+n.height/2-window.scrollY,i=document.elementsFromPoint(e,r).find(e=>!e.closest(`[data-annotation-marker]`)&&!e.closest(`[data-agentation-root]`));i&&t.push(i)}Me(t),je(null)}else if(e.boundingBox){let t=e.boundingBox,n=Ki(t.x+t.width/2,e.isFixed?t.y+t.height/2:t.y+t.height/2-window.scrollY);if(n){let e=n.getBoundingClientRect(),r=e.width/t.width,i=e.height/t.height;je(r<.5||i<.5?null:n)}else je(null);Me([])}else je(null),Me([])},[]),qr=(0,b.useCallback)(e=>{if(!L)return;let t={...L,comment:e};v(e=>e.map(e=>e.id===L.id?t:e)),a?.(t),Hr(`annotation.update`,{annotation:t}),u&&Fr(u,L.id,{comment:e}).catch(e=>{console.warn(`[Agentation] Failed to update annotation on server:`,e)}),Wn(!0),P(()=>{Le(null),ze(null),Ve([]),Wn(!1)},150)},[L,a,Hr,u]),Jr=(0,b.useCallback)(()=>{Wn(!0),P(()=>{Le(null),ze(null),Ve([]),Wn(!1)},150)},[]),Yr=(0,b.useCallback)(()=>{let e=_.length,t=B.length>0||!!V;if(e===0&&Wt.length===0&&!t)return;if(o?.(_),Hr(`annotations.clear`,{annotations:_}),u){Promise.all(_.map(e=>Ir(u,e.id).catch(e=>{console.warn(`[Agentation] Failed to delete annotation from server:`,e)})));for(let[,e]of zt.current)e&&Ir(u,e).catch(()=>{});zt.current.clear();for(let[,e]of Bt.current)e&&Ir(u,e).catch(()=>{});Bt.current.clear()}Ee(!0),Ce(!0),Gt([]);let n=Xt.current;if(n){let e=n.getContext(`2d`);e&&e.clearRect(0,0,n.width,n.height)}(B.length>0||V)&&(jt(e=>e+1),Nt(e=>e+1),P(()=>{ot([]),St(null)},200)),ut&&dt(!1),vt&&yt(``),Tt.current={rearrange:null,placements:[]},Cr(K),P(()=>{v([]),Ln(new Set),localStorage.removeItem(sr(K)),Ee(!1)},e*30+200),P(()=>Ce(!1),1500)},[K,_,Wt,B,V,ut,vt,o,Hr,u]),Xr=(0,b.useCallback)(async()=>{let e=typeof window<`u`?window.location.pathname+window.location.search+window.location.hash:K,t=z&&ut,n;if(t){if(B.length===0&&!V&&!vt)return;n=``}else{if(n=xi(_,e,G.outputDetail),!n&&Wt.length===0&&B.length===0&&!V)return;n||=`## Page Feedback: ${e}
...
`+e)}c&&c(t,_),N(`sending`),await new Promise(e=>P(e,150));let n=await Hr(`submit`,{output:t,annotations:_},!0);N(n?`sent`:`failed`),P(()=>N(`idle`),2500),n&&G.autoClearAfterCopy&&P(()=>Yr(),500)},[c,Hr,_,B,V,ut,gt,K,G.outputDetail,`off`,G.autoClearAfterCopy,Yr]);(0,b.useEffect)(()=>{if(!Nn)return;let e=e=>{let t=e.clientX-Nn.x,n=e.clientY-Nn.y,r=Math.sqrt(t*t+n*n);if(!jn&&r>10&&Mn(!0),jn||r>10){let e=Nn.toolbarX+t,r=Nn.toolbarY+n,i=20-(337-(h?En===`connected`?297:257:44)),a=window.innerWidth-20-337;e=Math.max(i,Math.min(a,e)),r=Math.max(20,Math.min(window.innerHeight-44-20,r)),An({x:e,y:r})}},t=()=>{jn&&(Fn.current=!0),Mn(!1),Pn(null)};return document.addEventListener(`mousemove`,e),document.addEventListener(`mouseup`,t),()=>{document.removeEventListener(`mousemove`,e),document.removeEventListener(`mouseup`,t)}},[Nn,jn,h,En]);let Qr=(0,b.useCallback)(e=>{if(e.target.closest(`button`)||e.target.closest(`[data-agentation-settings-panel]`))return;let t=e.currentTarget.parentElement;if(!t)return;let n=t.getBoundingClientRect(),r=On?.x??n.left,i=On?.y??n.top;Pn({x:e.clientX,y:e.clientY,toolbarX:r,toolbarY:i})},[On]);if((0,b.useEffect)(()=>{if(!On)return;let e=()=>{let e=On.x,t=On.y,n=20-(337-(h?En===`connected`?297:257:44)),r=window.innerWidth-20-337;e=Math.max(n,Math.min(r,e)),t=Math.max(20,Math.min(window.innerHeight-44-20,t)),(e!==On.x||t!==On.y)&&An({x:e,y:t})};return e(),window.addEventListener(`resize`,e),()=>window.removeEventListener(`resize`,e)},[On,h,En]),(0,b.useEffect)(()=>{let e=e=>{let t=e.target,n=t.tagName===`INPUT`||t.tagName===`TEXTAREA`||t.isContentEditable;if(e.key===`Escape`){if(z){st?ct(null):Tr();return}if(Ht){Ut(!1);return}if(Qt.length>0){$t([]);return}M||h&&(rn(),g(!1))}if((e.metaKey||e.ctrlKey)&&e.shiftKey&&(e.key===`f`||e.key===`F`)){e.preventDefault(),rn(),h?kr():g(!0);return}if(!(n||e.metaKey||e.ctrlKey)&&((e.key===`p`||e.key===`P`)&&(e.preventDefault(),rn(),zr()),(e.key===`l`||e.key===`L`)&&(e.preventDefault(),rn(),Ht&&Ut(!1),Ye&&Xe(!1),M&&Wr(),z?Tr():rt(!0)),(e.key===`h`||e.key===`H`)&&_.length>0&&(e.preventDefault(),rn(),C(e=>!e)),(e.key===`c`||e.key===`C`)&&(_.length>0||B.length>0||V)&&(e.preventDefault(),rn(),Xr()),(e.key===`x`||e.key===`X`)&&(_.length>0||B.length>0||V)&&(e.preventDefault(),rn(),Yr(),B.length>0&&ot([]),V&&St(null)),e.key===`s`||e.key===`S`)){let t=Wi(G.webhookUrl)||Wi(p||``);_.length>0&&t&&_e===`idle`&&(e.preventDefault(),rn(),Zr())}};return document.addEventListener(`keydown`,e),()=>document.removeEventListener(`keydown`,e)},[h,Ht,z,st,B,V,M,_.length,G.webhookUrl,p,_e,Zr,zr,Xr,Yr,Qt]),!R||w)return null;let $r=_.length>0,ei=_.filter(e=>!Rn.has(e.id)&&e.kind!==`placement`&&e.kind!==`rearrange`),ti=ei.length>0,ni=_.filter(e=>Rn.has(e.id)),ri=e=>{let t=e.x/100*window.innerWidth,n=typeof e.y==`string`?parseFloat(e.y):e.y,r={};window.innerHeight-n-22-10<80&&(r.top=`auto`,r.bottom=`calc(100% + 10px)`);let i=t-200/2;return i<10?r.left=`calc(50% + ${10-i}px)`:i+200>window.innerWidth-10&&(r.left=`calc(50% - ${i+200-(window.innerWidth-10)}px)`),r};return(0,x.createPortal)((0,S.jsxs)(`div`,{ref:E,style:{display:`contents`},"data-agentation-theme":mn?`dark`:`light`,"data-agentation-accent":G.annotationColorId,"data-agentation-root":``,children:[(0,S.jsx)(`div`,{className:`${q.toolbar}${m?` ${m}`:``}`,"data-feedback-toolbar":!0,"data-agentation-toolbar":!0,style:On?{left:On.x,top:On.y,right:`auto`,bottom:`auto`}:void 0,children:(0,S.jsxs)(`div`,{className:`${q.toolbarContainer} ${h?q.expanded:q.collapsed} ${bn?q.entrance:``} ${ee?q.hiding:``} ${!G.webhooksEnabled&&(Wi(G.webhookUrl)||Wi(p||``))?q.serverConnected:``}`,onClick:h?void 0:e=>{if(Fn.current){Fn.current=!1,e.preventDefault();return}g(!0)},onMouseDown:Qr,role:h?void 0:`button`,tabIndex:h?-1:0,title:h?void 0:`Start feedback mode`,children:[(0,S.jsxs)(`div`,{className:`${q.toggleContent} ${h?q.hidden:q.visible}`,children:[(0,S.jsx)(re,{size:24}),ti&&(0,S.jsx)(`span`,{className:`${q.badge} ${h?q.fadeOut:``} ${bn?q.entrance:``}`,children:ei.length})]}),(0,S.jsxs)(`div`,{className:`${q.controlsContent} ${h?q.visible:q.hidden} ${On&&On.y<100?q.tooltipBelow:``} ${tt||Ye?q.tooltipsHidden:``} ${U?q.tooltipsInSession:``}`,onMouseEnter:un,onMouseLeave:dn,children:[(0,S.jsxs)(`div`,{className:`${q.buttonWrapper} ${On&&On.x<120?q.buttonWrapperAlignLeft:``}`,children:[(0,S.jsx)(`button`,{className:q.controlButton,onClick:e=>{e.stopPropagation(),rn(),zr()},"data-active":qe,children:(0,S.jsx)(ce,{size:24,isPaused:qe})}),(0,S.jsxs)(`span`,{className:q.buttonTooltip,children:[qe?`Resume animations`:`Pause animations`,(0,S.jsx)(`span`,{className:q.shortcut,children:`P`})]})]}),(0,S.jsxs)(`div`,{className:q.buttonWrapper,children:[(0,S.jsx)(`button`,{className:`${q.controlButton} ${mn?``:q.light}`,onClick:e=>{e.stopPropagation(),rn(),Ht&&Ut(!1),Ye&&Xe(!1),M&&Wr(),z?Tr():rt(!0)},"data-active":z,style:z&&ut?{color:`#f97316`,background:`rgba(249, 115, 22, 0.25)`}:void 0,children:(0,S.jsx)(pe,{size:21})}),(0,S.jsxs)(`span`,{className:q.buttonTooltip,children:[z?`Exit layout mode`:`Layout mode`,(0,S.jsx)(`span`,{className:q.shortcut,children:`L`})]})]}),(0,S.jsxs)(`div`,{className:q.buttonWrapper,children:[(0,S.jsx)(`button`,{className:q.controlButton,onClick:e=>{e.stopPropagation(),rn(),C(!y)},disabled:!$r||z,children:(0,S.jsx)(se,{size:24,isOpen:y})}),(0,S.jsxs)(`span`,{className:q.buttonTooltip,children:[y?`Hide markers`:`Show markers`,(0,S.jsx)(`span`,{className:q.shortcut,children:`H`})]})]}),(0,S.jsxs)(`div`,{className:q.buttonWrapper,children:[(0,S.jsx)(`button`,{className:`${q.controlButton} ${he?q.statusShowing:``}`,onClick:e=>{e.stopPropagation(),rn(),Xr()},disabled:z&&ut?B.length===0&&!V?.sections?.length:!$r&&Wt.length===0&&B.length===0&&!V?.sections?.length,"data-active":he,children:(0,S.jsx)(ae,{size:24,copied:he,tint:z&&ut&&(B.length>0||V?.sections?.length)?`#f97316`:void 0})}),(0,S.jsxs)(`span`,{className:q.buttonTooltip,children:[z&&ut?`Copy layout`:`Copy feedback`,(0,S.jsx)(`span`,{className:q.shortcut,children:`C`})]})]}),(0,S.jsxs)(`div`,{className:`${q.buttonWrapper} ${q.sendButtonWrapper} ${h&&!G.webhooksEnabled&&(Wi(G.webhookUrl)||Wi(p||``))?q.sendButtonVisible:``}`,children:[(0,S.jsxs)(`button`,{className:`${q.controlButton} ${_e===`sent`||_e===`failed`?q.statusShowing:``}`,onClick:e=>{e.stopPropagation(),rn(),Zr()},disabled:!$r||!Wi(G.webhookUrl)&&!Wi(p||``)||_e===`sending`,"data-no-hover":_e===`sent`||_e===`failed`,tabIndex:Wi(G.webhookUrl)||Wi(p||``)?0:-1,children:[(0,S.jsx)(oe,{size:24,state:_e}),$r&&_e===`idle`&&(0,S.jsx)(`span`,{className:q.buttonBadge,children:_.length})]}),(0,S.jsxs)(`span`,{className:q.buttonTooltip,children:[`Send Annotations`,(0,S.jsx)(`span`,{className:q.shortcut,children:`S`})]})]}),(0,S.jsxs)(`div`,{className:q.buttonWrapper,children:[(0,S.jsx)(`button`,{className:q.controlButton,onClick:e=>{e.stopPropagation(),rn(),Yr()},disabled:!$r&&Wt.length===0&&B.length===0&&!V?.sections?.length,"data-danger":!0,children:(0,S.jsx)(O,{size:24})}),(0,S.jsxs)(`span`,{className:q.buttonTooltip,children:[`Clear all`,(0,S.jsx)(`span`,{className:q.shortcut,children:`X`})]})]}),(0,S.jsxs)(`div`,{className:q.buttonWrapper,children:[(0,S.jsx)(`button`,{className:q.controlButton,onClick:e=>{e.stopPropagation(),rn(),z&&Tr(),Xe(!Ye)},children:(0,S.jsx)(D,{size:24})}),u&&En!==`disconnected`&&(0,S.jsx)(`span`,{className:`${q.mcpIndicator} ${q[En]} ${Ye?q.hidden:``}`,title:En===`connected`?`MCP Connected`:`MCP Connecting...`}),(0,S.jsx)(`span`,{className:q.buttonTooltip,children:`Settings`})]}),(0,S.jsx)(`div`,{className:q.divider}),(0,S.jsxs)(`div`,{className:`${q.buttonWrapper} ${On&&typeof window<`u`&&On.x>window.innerWidth-120?q.buttonWrapperAlignRight:``}`,children:[(0,S.jsx)(`button`,{className:q.controlButton,onClick:e=>{e.stopPropagation(),rn(),kr()},children:(0,S.jsx)(le,{size:24})}),(0,S.jsxs)(`span`,{className:q.buttonTooltip,children:[`Exit`,(0,S.jsx)(`span`,{className:q.shortcut,children:`Esc`})]})]})]}),(0,S.jsx)(en,{visible:z&&h,activeType:st,onSelect:e=>{ct(st===e?null:e)},isDarkMode:mn,sectionCount:V?.sections.length??0,onDetectSections:()=>{let e=kn(),t=V?.sections??[],n=new Set(t.map(e=>e.selector)),r=e.filter(e=>!n.has(e.selector));St({sections:[...t,...r],originalOrder:[...V?.originalOrder??[],...r.map(e=>e.id)],detectedAt:Date.now()})},placementCount:B.length,onClearPlacements:()=>{jt(e=>e+1),Nt(e=>e+1),P(()=>{St({sections:[],originalOrder:[],detectedAt:Date.now()})},200)},blankCanvas:ut,onBlankCanvasChange:e=>{let t={sections:[],originalOrder:[],detectedAt:Date.now()};e?(wt.current={rearrange:V,placements:B},St(Tt.current.rearrange||t),ot(Tt.current.placements),ct(null)):(Tt.current={rearrange:V,placements:B},St(wt.current.rearrange||t),ot(wt.current.placements)),dt(e)},wireframePurpose:vt,onWireframePurposeChange:yt,Tooltip:ke,onDragStart:(e,t)=>{t.preventDefault();let n=F[e],r=null,i=!1,a=t.clientX,o=t.clientY,s=t.target.closest(`[data-feedback-toolbar]`)?.getBoundingClientRect().top??window.innerHeight,c=t=>{let c=t.clientX-a,l=t.clientY-o;if(!i&&(Math.abs(c)>4||Math.abs(l)>4)&&(i=!0,r=document.createElement(`div`),r.className=`${H.dragPreview}${ut?` ${H.dragPreviewWireframe}`:``}`,document.body.appendChild(r)),!r)return;let u=Math.max(0,s-t.clientY),d=1-(1-Math.min(1,u/180))**2,f=Math.min(140,n.width*.18),p=Math.min(90,n.height*.18),m=28+(f-28)*d,h=20+(p-20)*d;r.style.width=`${m}px`,r.style.height=`${h}px`,r.style.left=`${t.clientX-m/2}px`,r.style.top=`${t.clientY-h/2}px`,r.style.opacity=`${.5+.5*d}`,r.textContent=d>.25?e:``},l=t=>{if(window.removeEventListener(`mousemove`,c),window.removeEventListener(`mouseup`,l),r&&document.body.removeChild(r),i){let r=n.width,i=n.height,a=window.scrollY,o=Math.max(0,t.clientX-r/2),s=Math.max(0,t.clientY+a-i/2),c={id:`dp-${Date.now()}-${Math.random().toString(36).slice(2,7)}`,type:e,x:o,y:s,width:r,height:i,scrollY:a,timestamp:Date.now()};ot(e=>[...e,c]),ct(null),Pt.current=new Set,Dt(e=>e+1)}};window.addEventListener(`mousemove`,c),window.addEventListener(`mouseup`,l)}}),(0,S.jsx)(Bi,{settings:G,onSettingsChange:e=>fn(t=>({...t,...e})),isDarkMode:mn,onToggleTheme:Sn,isDevMode:!1,connectionStatus:En,endpoint:u,isVisible:Ze,toolbarNearBottom:!!On&&On.y<230,settingsPage:$e,onSettingsPageChange:et,onHideToolbar:gr})]})}),(z||it)&&(0,S.jsx)(`div`,{className:`${H.blankCanvas} ${ft?H.visible:``} ${bt?H.gridActive:``}`,style:{"--canvas-opacity":mt},"data-feedback-toolbar":!0}),z&&ut&&ft&&(0,S.jsxs)(`div`,{className:H.wireframeNotice,"data-feedback-toolbar":!0,children:[(0,S.jsxs)(`div`,{className:H.wireframeOpacityRow,children:[(0,S.jsx)(`span`,{className:H.wireframeOpacityLabel,children:`Toggle Opacity`}),(0,S.jsx)(`input`,{type:`range`,className:H.wireframeOpacitySlider,min:0,max:1,step:.01,value:mt,onChange:e=>ht(Number(e.target.value))})]}),(0,S.jsxs)(`div`,{className:H.wireframeNoticeTitleRow,children:[(0,S.jsx)(`span`,{className:H.wireframeNoticeTitle,children:`Wireframe Mode`}),(0,S.jsx)(`span`,{className:H.wireframeNoticeDivider}),(0,S.jsx)(`button`,{className:H.wireframeStartOver,onClick:()=>{jt(e=>e+1),St({sections:[],originalOrder:[],detectedAt:Date.now()}),Tt.current={rearrange:null,placements:[]},yt(``),Cr(K)},children:`Start Over`})]}),`Drag components onto the canvas.`,(0,S.jsx)(`br`,{}),`Copied output will only include the wireframed layout.`]}),(z||it)&&(0,S.jsx)(Yt,{placements:B,onChange:ot,activeComponent:it?null:st,onActiveComponentChange:ct,isDarkMode:mn,exiting:it,onInteractionChange:xt,passthrough:!st,extraSnapRects:V?.sections.map(e=>e.currentRect),deselectSignal:Et,clearSignal:At,wireframe:ut,onSelectionChange:(e,t)=>{Pt.current=e,t||(Ft.current=new Set,kt(e=>e+1))},onDragMove:(e,t)=>{let n=Ft.current;if(!(!n.size||!V)){if(!It.current){It.current=new Map;for(let e of V.sections)n.has(e.id)&&It.current.set(e.id,{x:e.currentRect.x,y:e.currentRect.y})}for(let r of V.sections){if(!n.has(r.id)||!It.current.get(r.id))continue;let i=document.querySelector(`[data-rearrange-section="${r.id}"]`);i&&(i.style.transform=`translate(${e}px, ${t}px)`)}}},onDragEnd:(e,t,n)=>{let r=Ft.current,i=It.current;if(It.current=null,!(!r.size||!V||!i)){for(let e of r){let t=document.querySelector(`[data-rearrange-section="${e}"]`);t&&(t.style.transform=``)}n&&St(n=>n&&{...n,sections:n.sections.map(n=>{let r=i.get(n.id);return r?{...n,currentRect:{...n.currentRect,x:Math.max(0,r.x+e),y:Math.max(0,r.y+t)}}:n})})}}}),(z||it)&&V&&(0,S.jsx)(zn,{rearrangeState:V,onChange:St,isDarkMode:mn,exiting:it,blankCanvas:ut,extraSnapRects:B.map(e=>({x:e.x,y:e.y,width:e.width,height:e.height})),clearSignal:Mt,deselectSignal:Ot,onSelectionChange:(e,t)=>{Ft.current=e,t||(Pt.current=new Set,Dt(e=>e+1))},onDragMove:(e,t)=>{let n=Pt.current;if(n.size){if(!It.current){It.current=new Map;for(let e of B)n.has(e.id)&&It.current.set(e.id,{x:e.x,y:e.y})}for(let r of n){let n=document.querySelector(`[data-design-placement="${r}"]`);n&&(n.style.transform=`translate(${e}px, ${t}px)`)}}},onDragEnd:(e,t,n)=>{let r=Pt.current,i=It.current;if(It.current=null,!(!r.size||!i)){for(let e of r){let t=document.querySelector(`[data-design-placement="${e}"]`);t&&(t.style.transform=``)}n&&ot(n=>n.map(n=>{let r=i.get(n.id);return r?{...n,x:Math.max(0,r.x+e),y:Math.max(0,r.y+t)}:n}))}}}),(0,S.jsx)(`canvas`,{ref:Xt,className:`${q.drawCanvas} ${Ht?q.active:``}`,style:{opacity:+!!or,transition:`opacity 0.15s ease`},"data-feedback-toolbar":!0}),(0,S.jsxs)(`div`,{className:q.markersLayer,"data-feedback-toolbar":!0,children:[ne&&ei.filter(e=>!e.isFixed).map((e,t,n)=>(0,S.jsx)(wi,{annotation:e,globalIndex:ei.findIndex(t=>t.id===e.id),layerIndex:t,layerSize:n.length,isExiting:k,isClearing:Te,isAnimated:In.has(e.id),isHovered:!k&&De===e.id,isDeleting:Ne===e.id,isEditingAny:!!L,renumberFrom:Fe,markerClickBehavior:G.markerClickBehavior,tooltipStyle:ri(e),onHoverEnter:e=>!k&&e.id!==$n.current&&Kr(e),onHoverLeave:()=>Kr(null),onClick:e=>G.markerClickBehavior===`delete`?Gr(e.id):Vr(e),onContextMenu:Vr},e.id)),ne&&!k&&ni.filter(e=>!e.isFixed).map(e=>(0,S.jsx)(Ti,{annotation:e},e.id))]}),(0,S.jsxs)(`div`,{className:q.fixedMarkersLayer,"data-feedback-toolbar":!0,children:[ne&&ei.filter(e=>e.isFixed).map((e,t,n)=>(0,S.jsx)(wi,{annotation:e,globalIndex:ei.findIndex(t=>t.id===e.id),layerIndex:t,layerSize:n.length,isExiting:k,isClearing:Te,isAnimated:In.has(e.id),isHovered:!k&&De===e.id,isDeleting:Ne===e.id,isEditingAny:!!L,renumberFrom:Fe,markerClickBehavior:G.markerClickBehavior,tooltipStyle:ri(e),onHoverEnter:e=>!k&&e.id!==$n.current&&Kr(e),onHoverLeave:()=>Kr(null),onClick:e=>G.markerClickBehavior===`delete`?Gr(e.id):Vr(e),onContextMenu:Vr},e.id)),ne&&!k&&ni.filter(e=>e.isFixed).map(e=>(0,S.jsx)(Ti,{annotation:e,fixed:!0},e.id))]}),h&&(0,S.jsxs)(`div`,{className:q.overlay,"data-feedback-toolbar":!0,style:M||L?{zIndex:99999}:void 0,children:[A?.rect&&!M&&!We&&!Gn&&(0,S.jsx)(`div`,{className:`${q.hoverHighlight} ${q.enter}`,style:{left:A.rect.left,top:A.rect.top,width:A.rect.width,height:A.rect.height,borderColor:`color-mix(in srgb, var(--agentation-color-accent) 50%, transparent)`,backgroundColor:`color-mix(in srgb, var(--agentation-color-accent) 4%, transparent)`}}),Qt.filter(e=>document.contains(e.element)).map((e,t)=>{let n=e.element.getBoundingClientRect(),r=Qt.length>1;return(0,S.jsx)(`div`,{className:r?q.multiSelectOutline:q.singleSelectOutline,style:{position:`fixed`,left:n.left,top:n.top,width:n.width,height:n.height,...r?{}:{borderColor:`color-mix(in srgb, var(--agentation-color-accent) 60%, transparent)`,backgroundColor:`color-mix(in srgb, var(--agentation-color-accent) 5%, transparent)`}}},t)}),De&&!M&&(()=>{let e=_.find(e=>e.id===De);if(!e?.boundingBox)return null;if(e.elementBoundingBoxes?.length)return I.length>0?I.filter(e=>document.contains(e)).map((e,t)=>{let n=e.getBoundingClientRect();return(0,S.jsx)(`div`,{className:`${q.multiSelectOutline} ${q.enter}`,style:{left:n.left,top:n.top,width:n.width,height:n.height}},`hover-outline-live-${t}`)}):e.elementBoundingBoxes.map((e,t)=>(0,S.jsx)(`div`,{className:`${q.multiSelectOutline} ${q.enter}`,style:{left:e.x,top:e.y-He,width:e.width,height:e.height}},`hover-outline-${t}`));let t=Ae&&document.contains(Ae)?Ae.getBoundingClientRect():null,n=t?{x:t.left,y:t.top,width:t.width,height:t.height}:{x:e.boundingBox.x,y:e.isFixed?e.boundingBox.y:e.boundingBox.y-He,width:e.boundingBox.width,height:e.boundingBox.height},r=e.isMultiSelect;return(0,S.jsx)(`div`,{className:`${r?q.multiSelectOutline:q.singleSelectOutline} ${q.enter}`,style:{left:n.x,top:n.y,width:n.width,height:n.height,...r?{}:{borderColor:`color-mix(in srgb, var(--agentation-color-accent) 60%, transparent)`,backgroundColor:`color-mix(in srgb, var(--agentation-color-accent) 5%, transparent)`}}})})(),A&&!M&&!We&&!Gn&&(0,S.jsxs)(`div`,{className:`${q.hoverTooltip} ${q.enter}`,style:{left:Math.max(8,Math.min(j.x,window.innerWidth-100)),top:Math.max(j.y-(A.reactComponents?48:32),8)},children:[A.reactComponents&&(0,S.jsx)(`div`,{className:q.hoverReactPath,children:A.reactComponents}),(0,S.jsx)(`div`,{className:q.hoverElementName,children:A.elementName})]}),M&&(0,S.jsxs)(S.Fragment,{children:[M.multiSelectElements?.length?M.multiSelectElements.filter(e=>document.contains(e)).map((e,t)=>{let n=e.getBoundingClientRect();return(0,S.jsx)(`div`,{className:`${q.multiSelectOutline} ${Vn?q.exit:q.enter}`,style:{left:n.left,top:n.top,width:n.width,height:n.height}},`pending-multi-${t}`)}):M.targetElement&&document.contains(M.targetElement)?(()=>{let e=M.targetElement.getBoundingClientRect();return(0,S.jsx)(`div`,{className:`${q.singleSelectOutline} ${Vn?q.exit:q.enter}`,style:{left:e.left,top:e.top,width:e.width,height:e.height,borderColor:`color-mix(in srgb, var(--agentation-color-accent) 60%, transparent)`,backgroundColor:`color-mix(in srgb, var(--agentation-color-accent) 5%, transparent)`}})})():M.boundingBox&&(0,S.jsx)(`div`,{className:`${M.isMultiSelect?q.multiSelectOutline:q.singleSelectOutline} ${Vn?q.exit:q.enter}`,style:{left:M.boundingBox.x,top:M.boundingBox.y-He,width:M.boundingBox.width,height:M.boundingBox.height,...M.isMultiSelect?{}:{borderColor:`color-mix(in srgb, var(--agentation-color-accent) 60%, transparent)`,backgroundColor:`color-mix(in srgb, var(--agentation-color-accent) 5%, transparent)`}}}),(()=>{let e=M.x,t=M.isFixed?M.y:M.y-He;return(0,S.jsxs)(S.Fragment,{children:[(0,S.jsx)(Y,{x:e,y:t,isMultiSelect:M.isMultiSelect,isExiting:Vn}),(0,S.jsx)(we,{ref:tr,element:M.element,selectedText:M.selectedText,computedStyles:M.computedStylesObj,placeholder:M.element===`Area selection`?`What should change in this area?`:M.isMultiSelect?`Feedback for this group of elements...`:`What should change?`,onSubmit:Ur,onCancel:Wr,isExiting:Vn,lightMode:!mn,accentColor:M.isMultiSelect?`var(--agentation-color-green)`:`var(--agentation-color-accent)`,style:{left:Math.max(160,Math.min(window.innerWidth-160,e/100*window.innerWidth)),...t>window.innerHeight-290?{bottom:window.innerHeight-t+20}:{top:t+20}}})]})})()]}),L&&(0,S.jsxs)(S.Fragment,{children:[L.elementBoundingBoxes?.length?Be.length>0?Be.filter(e=>document.contains(e)).map((e,t)=>{let n=e.getBoundingClientRect();return(0,S.jsx)(`div`,{className:`${q.multiSelectOutline} ${q.enter}`,style:{left:n.left,top:n.top,width:n.width,height:n.height}},`edit-multi-live-${t}`)}):L.elementBoundingBoxes.map((e,t)=>(0,S.jsx)(`div`,{className:`${q.multiSelectOutline} ${q.enter}`,style:{left:e.x,top:e.y-He,width:e.width,height:e.height}},`edit-multi-${t}`)):(()=>{let e=Re&&document.contains(Re)?Re.getBoundingClientRect():null,t=e?{x:e.left,y:e.top,width:e.width,height:e.height}:L.boundingBox?{x:L.boundingBox.x,y:L.isFixed?L.boundingBox.y:L.boundingBox.y-He,width:L.boundingBox.width,height:L.boundingBox.height}:null;return t?(0,S.jsx)(`div`,{className:`${L.isMultiSelect?q.multiSelectOutline:q.singleSelectOutline} ${q.enter}`,style:{left:t.x,top:t.y,width:t.width,height:t.height,...L.isMultiSelect?{}:{borderColor:`color-mix(in srgb, var(--agentation-color-accent) 60%, transparent)`,backgroundColor:`color-mix(in srgb, var(--agentation-color-accent) 5%, transparent)`}}}):null})(),(0,S.jsx)(we,{ref:nr,element:L.element,selectedText:L.selectedText,computedStyles:gn(L.computedStyles),placeholder:`Edit your feedback...`,initialValue:L.comment,submitLabel:`Save`,onSubmit:qr,onCancel:Jr,onDelete:()=>Gr(L.id),isExiting:Un,lightMode:!mn,accentColor:L.isMultiSelect?`var(--agentation-color-green)`:`var(--agentation-color-accent)`,style:(()=>{let e=L.isFixed?L.y:L.y-He;return{left:Math.max(160,Math.min(window.innerWidth-160,L.x/100*window.innerWidth)),...e>window.innerHeight-290?{bottom:window.innerHeight-e+20}:{top:e+20}}})()})]}),Gn&&(0,S.jsxs)(S.Fragment,{children:[(0,S.jsx)(`div`,{ref:Yn,className:q.dragSelection}),(0,S.jsx)(`div`,{ref:Xn,className:q.highlightsContainer})]})]})]}),document.body)}var Zi=`visual-review-pages-annotation:v1`;function Qi({asset:e=`current`,context:t,itemId:n}){return[`visual-review-annotation`,ca(t.repository),ca(t.prNumber),ca(t.surface),ca(t.runKey),ca(t.headSha),ca(n),ca(e)].join(`:`)}function $i({annotation:e,imageRect:t,viewport:n}){let r=aa(e,n);return r.x>=t.x&&r.x<=t.x+t.width&&r.y>=t.y&&r.y<=t.y+t.height}function ea({annotation:e,imageRect:t,naturalSize:n,viewport:r}){let i=aa(e,r);if(!$i({annotation:e,imageRect:t,viewport:r}))throw RangeError(`Annotation point is outside the reviewed image bounds.`);let a=da((i.x-t.x)/t.width*100,3),o=da((i.y-t.y)/t.height*100,3),s=Math.round(a/100*n.width),c=Math.round(o/100*n.height),l=e.boundingBox?{x:la((e.boundingBox.x-t.x)/t.width*100),y:la((oa(e,r)-t.y)/t.height*100),width:la(e.boundingBox.width/t.width*100),height:la(e.boundingBox.height/t.height*100)}:void 0;return{pixelX:s,pixelY:c,xPct:a,yPct:o,...l?{boxPct:l}:{}}}function ta({files:e,target:t}){let n=Array.isArray(e)?e.find(e=>e?.filename===t?.path):null;return n?t?.line&&ra(n.patch,t.line)?{body:{line:t.line,side:`RIGHT`},kind:`line`,reason:``}:{body:{subject_type:`file`},kind:`file`,reason:t?.line?`The related source file is in this PR, but the exact line is not part of the diff; GitHub only accepts line comments on diff lines.`:``}:{kind:`timeline`,reason:`The related source file is not present in this PR diff, so GitHub cannot place an inline review comment there.`}}function na({annotation:e,placementReason:t=``}){let n=ia(e),r=[String(e.comment||e.agentation?.comment||``).trim(),``,`---`,`Visual annotation: [open annotation](${e.review.annotationPageUrl})`,`Raw image: [open image](${e.image.url})`];return e.target?.href?r.push(`Related source file: [${sa(e.target)}](${e.target.href})`):e.target?.path&&r.push(`Related source file: \`${sa(e.target)}\``),e.review?.runUrl&&r.push(`Workflow run: [${e.review.runKey||`run`}](${e.review.runUrl})`),r.push(`Snapshot artifact: \`${e.review.snapshot||e.image.rawFile||e.review.itemId}\``,`Surface: ${e.review.surface}`,`Head: \`${fa(e.review.headSha)}\``,`Image coordinates: \`${e.image.pixelX}, ${e.image.pixelY}\` px (\`${ua(e.image.xPct)}%, ${ua(e.image.yPct)}%\`)`),t&&r.push(`Placement note: ${t}`),r.push(``,`<!-- ${Zi} ${JSON.stringify(n)} -->`),r.join(`
`)}function ra(e,t){if(!e||!t)return!1;let n=0,r=0;for(let i of String(e).split(`
`)){let e=i.match(/^@@ -(\d+)(?:,\d+)? \+(\d+)(?:,\d+)? @@/);if(e){n=Number(e[1]),r=Number(e[2]);continue}if(i.startsWith(` `)){if(r===t)return!0;n+=1,r+=1}else if(i.startsWith(`+`)){if(r===t)return!0;r+=1}else i.startsWith(`-`)&&(n+=1)}return!1}function ia(e){return{annotationId:String(e.id||``),asset:String(e.review.asset||``),headSha:String(e.review.headSha||``),itemId:String(e.review.itemId||``),pixelX:e.image.pixelX,pixelY:e.image.pixelY,prNumber:String(e.review.prNumber||``),repository:String(e.review.repository||``),runKey:String(e.review.runKey||``),snapshot:String(e.review.snapshot||``),sourceLine:e.target?.line||null,sourcePath:e.target?.path||null,surface:String(e.review.surface||``),xPct:e.image.xPct,yPct:e.image.yPct}}function aa(e,t={}){let n=Number(t.width||globalThis.innerWidth||0),r=Number(t.scrollY??globalThis.scrollY??0),i=Number(e?.x||0),a=Number(e?.y||0);return{x:n>0?i/100*n:i,y:e?.isFixed?a:a-r}}function oa(e,t={}){let n=Number(e?.boundingBox?.y||0),r=Number(t.scrollY??globalThis.scrollY??0);return e?.isFixed?n:n-r}function sa(e){return e?.line?`${e.path}:${e.line}`:e?.path||``}function ca(e){return String(e??``).replaceAll(`:`,`_`)}function la(e){return da(Math.min(100,Math.max(0,Number.isFinite(e)?e:0)),3)}function ua(e){return Number(e).toLocaleString(`en-US`,{maximumFractionDigits:3,useGrouping:!1})}function da(e,t){let n=10**t;return Math.round(e*n)/n}function fa(e){return String(e||``).slice(0,7)||`unknown`}var pa=document.getElementById(`visual-annotation-root`),ma=`visual-review:theme`;eo(),pa&&(0,y.createRoot)(pa).render((0,S.jsx)(ha,{}));function ha(){let[e,t]=(0,b.useState)(null),[n,r]=(0,b.useState)(``),[i,a]=(0,b.useState)(new URLSearchParams(window.location.search).get(`asset`)||`current`),[o,s]=(0,b.useState)(``),[c,l]=(0,b.useState)(``),[u,d]=(0,b.useState)(`Token optional`),[f,p]=(0,b.useState)([]),[m,h]=(0,b.useState)(``),[g,_]=(0,b.useState)(``),[v,y]=(0,b.useState)(``),[x,C]=(0,b.useState)(!1),[w,T]=(0,b.useState)(``),[ee,te]=(0,b.useState)(null),[E,ne]=(0,b.useState)(100),re=(0,b.useRef)(null),ie=ro(),[ae,oe]=(0,b.useState)(za);(0,b.useEffect)(()=>{Ba(ae),localStorage.setItem(ma,ae)},[ae]),(0,b.useEffect)(()=>{ga().then(t).catch(e=>r(e.message))},[]);let se=(0,b.useMemo)(()=>e?ya(e.payload):[],[e]),ce=new URLSearchParams(window.location.search).get(`id`),D=se.find(e=>e.id===ce)||se[0],O=e?.context||{},k=D?Ca(D,i):null,le=D?Aa(D):null,ue=D&&k?Qi({asset:k.kind,context:O,itemId:D.id}):``;(0,b.useEffect)(()=>{let e=sessionStorage.getItem(Ra(O))||``;s(e),l(``),d(e?`Token entered`:`Token optional`)},[O.repository,O.prNumber]),(0,b.useEffect)(()=>{ue&&(p(Da(ue)),h(``),_(``),y(``),T(``))},[ue]),(0,b.useEffect)(()=>{let e=()=>{y(`Annotation ignored. Click directly inside the reviewed image.`)};return window.addEventListener(`visual-review-annotation-blocked`,e),()=>window.removeEventListener(`visual-review-annotation-blocked`,e)},[]),(0,b.useEffect)(()=>{k&&k.kind!==i&&a(k.kind)},[i,k]),(0,b.useEffect)(()=>{let e=e=>{e.__visualReviewAnnotationHotkeyHandled||e.defaultPrevented||e.metaKey||e.ctrlKey||e.altKey||String(e.key||``).toLowerCase()===`a`&&($a(e.target)||(e.__visualReviewAnnotationHotkeyHandled=!0,e.preventDefault(),Ja()))};return window.addEventListener(`keydown`,e,!0),document.addEventListener(`keydown`,e,!0),()=>{window.removeEventListener(`keydown`,e,!0),document.removeEventListener(`keydown`,e,!0)}},[]);let A=(0,b.useCallback)(e=>{p(e),ue&&localStorage.setItem(ue,JSON.stringify(e))},[ue]),de=(0,b.useCallback)(e=>{if(!D||!k||!re.current)return;let t=re.current.getBoundingClientRect(),n={width:re.current.naturalWidth||t.width,height:re.current.naturalHeight||t.height},r={scrollY:window.scrollY,width:window.innerWidth};if(!$i({annotation:e,imageRect:t,viewport:r})){y(`Annotation ignored. Click directly inside the reviewed image.`);return}let i=ea({annotation:e,imageRect:t,naturalSize:n,viewport:r});y(``),A(Oa(f,{schemaVersion:1,id:e.id,comment:String(e.comment||``).trim(),agentation:e,github:{status:`pending`},image:{...i,naturalHeight:n.height,naturalWidth:n.width,rawFile:D.raw,url:k.url,valid:!0},review:{annotationPageUrl:window.location.href,asset:k.kind,headSha:O.headSha,itemId:D.id,prNumber:O.prNumber,repository:O.repository,reviewPageUrl:ka(D),runKey:O.runKey,runUrl:O.runUrl,snapshot:D.raw,surface:O.surface},target:le?{href:Ma(O,le),line:le.line,path:le.path}:{href:null,line:null,path:null}})),window.setTimeout(Xa,0)},[f,O,D,A,k,le]),j=(0,b.useCallback)(e=>{h(e.id),_(e.comment||``)},[]),fe=(0,b.useCallback)(()=>{h(``),_(``)},[]),pe=(0,b.useCallback)(e=>{let t=g.trim();A(f.map(n=>n.id===e?{...n,agentation:{...n.agentation,comment:t},comment:t,github:n.github?.status===`posted`?{status:`pending`}:n.github}:n)),fe(),T(``)},[f,fe,g,A]),M=(0,b.useCallback)(e=>{A(f.filter(t=>t.id!==e)),m===e&&fe(),T(``)},[f,fe,m,A]),me=(0,b.useCallback)(()=>{A([]),fe(),y(``),T(``)},[fe,A]),he=(0,b.useCallback)(e=>{M(e.id)},[M]),ge=(0,b.useCallback)(()=>{me()},[me]);async function _e(){let e=o.trim();if(!e){sessionStorage.removeItem(Ra(O)),l(``),d(`Token cleared.`);return}sessionStorage.setItem(Ra(O),e),d(`Checking GitHub token...`);try{let t=await Ea(`/user`,{context:O,token:e});l(t.login||``),d(`Signed in @${t.login||`GitHub user`}`)}catch(e){d(e.message)}}async function N(){if(!o.trim()){T(`GitHub token required to post annotation comments.`);return}let e=f.filter(e=>e.github?.status!==`posted`);if(e.length===0){T(`No pending annotations to post.`);return}C(!0),T(`Posting annotation comments...`);let t=[...f];try{let n=ee||await Ta({context:O,token:o});ee||te(n);for(let r of e){let e=ta({files:n,target:r.target}),i=na({annotation:r,placementReason:e.reason}),a=e.kind===`timeline`?await Ea(`/repos/${O.repository}/issues/${O.prNumber}/comments`,{body:{body:i},context:O,method:`POST`,token:o}):await Ea(`/repos/${O.repository}/pulls/${O.prNumber}/comments`,{body:{...e.body,body:i,commit_id:O.headSha,path:r.target.path},context:O,method:`POST`,token:o}),s=t.findIndex(e=>e.id===r.id);s>=0&&(t[s]={...t[s],github:{commentId:a?.id||null,htmlUrl:a?.html_url||``,placement:e.kind,status:`posted`}})}A(t),T(`Posted ${e.length} annotation comment${e.length===1?``:`s`} to PR #${O.prNumber}.`)}catch(e){T(e.message)}finally{C(!1)}}return n?(0,S.jsxs)(`main`,{className:`annotation-empty`,children:[(0,S.jsx)(`h1`,{children:`Unable to load visual report`}),(0,S.jsx)(`p`,{children:n})]}):!e||!D||!k?(0,S.jsx)(`main`,{className:`annotation-empty`,children:(0,S.jsx)(`h1`,{children:`Loading annotation review`})}):(0,S.jsxs)(`div`,{className:`annotation-shell`,children:[(0,S.jsx)(`header`,{className:`topbar annotation-topbar`,children:(0,S.jsxs)(`div`,{className:`topbar-inner`,children:[(0,S.jsxs)(`div`,{className:`topbar-title`,children:[(0,S.jsxs)(`nav`,{className:`crumbs`,"aria-label":`Breadcrumb`,children:[(0,S.jsxs)(`a`,{href:O.prIndexHref,children:[`PR #`,O.prNumber]}),(0,S.jsx)(`span`,{children:`/`}),(0,S.jsx)(`a`,{href:ka(D),children:O.surfaceLabel}),(0,S.jsx)(`span`,{children:`/`}),(0,S.jsx)(`span`,{children:`Image annotation`})]}),(0,S.jsx)(`h1`,{children:Fa(D)}),(0,S.jsxs)(`div`,{className:`meta-row`,children:[(0,S.jsx)(`span`,{children:Ha(D.variant)}),(0,S.jsx)(`span`,{children:Ia(D)}),(0,S.jsxs)(`span`,{children:[`Commit `,Ga(O.headSha)]})]})]}),(0,S.jsxs)(`div`,{className:`annotation-actions`,"data-annotation-control":!0,onClick:Qa,onMouseDown:Qa,onPointerDown:Qa,children:[(0,S.jsx)(`button`,{"aria-pressed":ae===`dark`,className:`btn theme-toggle`,onClick:()=>oe(Va(ae)),type:`button`,children:ae===`dark`?`Light`:`Dark`}),(0,S.jsx)(`a`,{className:`btn`,href:ka(D),children:`Back to queue`}),(0,S.jsx)(`a`,{className:`btn`,href:k.url,target:`_blank`,rel:`noopener noreferrer`,children:`Open raw image`})]})]})}),(0,S.jsxs)(`main`,{className:`annotation-workspace`,children:[(0,S.jsx)(`section`,{className:`annotation-canvas`,"aria-label":`Selected visual artifact`,children:(0,S.jsxs)(`article`,{className:`viewer-card annotation-viewer-card`,children:[(0,S.jsxs)(`div`,{className:`viewer-toolbar`,children:[(0,S.jsxs)(`div`,{className:`snapshot-heading`,children:[(0,S.jsx)(`h2`,{children:k.label}),(0,S.jsx)(`p`,{children:D.raw})]}),(0,S.jsxs)(`div`,{className:`toolbar-controls`,children:[(0,S.jsx)(`div`,{className:`segmented`,role:`group`,"aria-label":`Image asset`,children:wa(D).map(e=>(0,S.jsx)(`button`,{className:k.kind===e.kind?`active`:``,"data-asset":e.kind,onClick:()=>a(e.kind),type:`button`,children:e.label},e.kind))}),(0,S.jsxs)(`label`,{className:`range-row`,children:[`Zoom`,(0,S.jsx)(`input`,{max:`200`,min:`50`,onChange:e=>ne(Number(e.target.value)),step:`1`,type:`range`,value:E}),(0,S.jsxs)(`span`,{children:[E,`%`]})]})]})]}),(0,S.jsx)(`div`,{className:`stage annotation-stage`,children:(0,S.jsx)(`div`,{className:`stage-inner annotation-stage-inner`,style:{zoom:E/100},children:(0,S.jsxs)(`div`,{className:`annotation-image-frame`,"data-annotation-frame":!0,children:[(0,S.jsx)(`img`,{alt:`${k.label} for ${D.raw}`,className:`solo-image annotation-image-target`,"data-annotation-image":!0,ref:re,src:k.url}),(0,S.jsx)(`div`,{className:`annotation-image-marker-layer`,"aria-hidden":`true`,children:f.map((e,t)=>(0,S.jsx)(`span`,{className:`annotation-image-marker ${e.github?.status||`pending`}`,style:{left:qa(e.image?.xPct),top:qa(e.image?.yPct)},title:e.comment||`Image annotation`,children:t+1},e.id))})]})})})]})}),(0,S.jsxs)(`aside`,{"aria-label":`Image annotation workflow`,className:`annotation-review-panel`,"data-annotation-control":!0,onClick:Qa,onMouseDown:Qa,onPointerDown:Qa,children:[(0,S.jsxs)(`section`,{className:`annotation-card`,children:[(0,S.jsxs)(`div`,{className:`brief-topline`,children:[(0,S.jsx)(`span`,{children:`Image annotations`}),(0,S.jsxs)(`span`,{className:`decision-pill open`,children:[f.length,` local`]})]}),(0,S.jsx)(`h2`,{children:`Mark the image, then post PR comments`}),(0,S.jsxs)(`p`,{className:`brief-description`,children:[`Annotations are saved in this browser for PR #`,O.prNumber,`. Posting creates review comments with image coordinates for future remediation.`]}),ie?(0,S.jsxs)(`ol`,{className:`sync-steps annotation-steps`,children:[(0,S.jsxs)(`li`,{children:[(0,S.jsx)(`span`,{children:`1`}),(0,S.jsxs)(`p`,{children:[(0,S.jsx)(`strong`,{children:`Activate Agentation`}),` from the floating toolbar or press `,(0,S.jsx)(`kbd`,{children:`A`}),`.`]})]}),(0,S.jsxs)(`li`,{children:[(0,S.jsx)(`span`,{children:`2`}),(0,S.jsxs)(`p`,{children:[(0,S.jsx)(`strong`,{children:`Mark the image`}),` and describe what needs to change.`]})]}),(0,S.jsxs)(`li`,{children:[(0,S.jsx)(`span`,{children:`3`}),(0,S.jsxs)(`p`,{children:[(0,S.jsx)(`strong`,{children:`Review drafts`}),` below. Edit, remove, or clear them before posting.`]})]}),(0,S.jsxs)(`li`,{children:[(0,S.jsx)(`span`,{children:`4`}),(0,S.jsxs)(`p`,{children:[(0,S.jsx)(`strong`,{children:`Post to PR`}),` to leave durable reviewer context.`]})]})]}):(0,S.jsxs)(`div`,{className:`inline-comment-target missing`,children:[(0,S.jsx)(`span`,{children:`Desktop required`}),(0,S.jsx)(`strong`,{children:`Agentation annotations are not available on mobile.`}),(0,S.jsx)(`p`,{children:`Open this page on a desktop browser to mark the screenshot.`})]}),v?(0,S.jsx)(`p`,{className:`comment-status error`,children:v}):null]}),(0,S.jsxs)(`section`,{className:`annotation-card`,children:[(0,S.jsxs)(`div`,{className:`annotation-section-header`,children:[(0,S.jsx)(`h3`,{children:`Pending annotation comments`}),f.length>0?(0,S.jsx)(`button`,{className:`btn`,onClick:me,type:`button`,children:`Clear all annotations`}):null]}),f.length===0?(0,S.jsx)(`p`,{className:`annotation-muted`,children:`No annotations saved for this image yet.`}):(0,S.jsx)(`div`,{className:`annotation-list`,children:f.map((e,t)=>(0,S.jsxs)(`article`,{className:`annotation-note ${e.github?.status||`pending`}`,children:[(0,S.jsx)(`div`,{className:`annotation-note-main`,children:m===e.id?(0,S.jsxs)(`label`,{className:`annotation-edit-form`,children:[(0,S.jsxs)(`span`,{children:[`Edit annotation `,t+1]}),(0,S.jsx)(`textarea`,{"aria-label":`Edit annotation comment ${t+1}`,className:`annotation-edit-field`,onChange:e=>_(e.target.value),rows:`3`,value:g})]}):(0,S.jsxs)(S.Fragment,{children:[(0,S.jsx)(`strong`,{children:e.comment||`Annotation without comment`}),(0,S.jsxs)(`p`,{children:[`Image coordinate: `,e.image.pixelX,`, `,e.image.pixelY,` px (`,Ka(e.image.xPct),`%, `,Ka(e.image.yPct),`%)`]}),e.github?.htmlUrl?(0,S.jsx)(`a`,{href:e.github.htmlUrl,target:`_blank`,rel:`noopener noreferrer`,children:`Open PR comment`}):null]})}),(0,S.jsxs)(`div`,{className:`annotation-note-side`,children:[(0,S.jsx)(`span`,{children:e.github?.status||`pending`}),m===e.id?(0,S.jsxs)(`div`,{className:`annotation-note-actions`,children:[(0,S.jsxs)(`button`,{className:`btn primary`,onClick:()=>pe(e.id),type:`button`,children:[`Save annotation `,t+1]}),(0,S.jsxs)(`button`,{className:`btn`,onClick:fe,type:`button`,children:[`Cancel edit annotation `,t+1]})]}):(0,S.jsxs)(`div`,{className:`annotation-note-actions`,children:[(0,S.jsxs)(`button`,{className:`btn`,onClick:()=>j(e),type:`button`,children:[`Edit annotation `,t+1]}),(0,S.jsxs)(`button`,{className:`btn`,onClick:()=>M(e.id),type:`button`,children:[`Remove annotation `,t+1]})]})]})]},e.id))})]}),(0,S.jsxs)(`section`,{className:`annotation-card`,children:[(0,S.jsx)(`h3`,{children:`GitHub posting`}),(0,S.jsxs)(`div`,{className:`sync-status-line`,children:[(0,S.jsx)(`span`,{children:`Status`}),(0,S.jsx)(`strong`,{children:c?`@${c}`:u})]}),(0,S.jsxs)(`label`,{className:`token-field`,children:[(0,S.jsx)(`span`,{children:`GitHub token`}),(0,S.jsx)(`input`,{className:`token-input`,onChange:e=>s(e.target.value),placeholder:`Paste token for PR review comments`,type:`password`,value:o}),(0,S.jsx)(`small`,{children:`Stored only in this tab's sessionStorage.`})]}),(0,S.jsxs)(`div`,{className:`sync-action-group`,children:[(0,S.jsx)(`button`,{className:`btn`,onClick:_e,type:`button`,children:`Use token`}),(0,S.jsx)(`button`,{className:`btn primary`,disabled:x||f.length===0,onClick:N,type:`button`,children:`Post to PR`})]}),w?(0,S.jsx)(`p`,{className:`comment-status ready`,children:w}):null,(0,S.jsx)(`p`,{className:`annotation-muted`,children:`Posting annotations does not approve this image. Return to the queue for final disposition.`})]})]})]}),ie?(0,S.jsx)(Xi,{className:`agentation-review-toolbar`,copyToClipboard:!1,onAnnotationAdd:de,onAnnotationDelete:he,onAnnotationUpdate:de,onAnnotationsClear:ge}):null]})}async function ga(){let e=document.getElementById(`visual-review-data`)?.textContent;if(e)return JSON.parse(e);let t=await fetch(`./index.html`,{cache:`no-store`});if(!t.ok)throw Error(`index.html returned ${t.status}`);let n=_a(await t.text());if(n)return n;let r=await fetch(`./reg-viz.html`,{cache:`no-store`});if(!r.ok)throw Error(`Visual report data was not found in index.html or reg-viz.html.`);return{context:{},payload:va(await r.text())}}function _a(e){let t=new DOMParser().parseFromString(e,`text/html`).getElementById(`visual-review-data`);return t?.textContent?JSON.parse(t.textContent):null}function va(e){let t=e.match(/window\[['"]__reg__['"]\]\s*=\s*(\{[\s\S]*?\});?\s*<\/script>/);if(!t)throw Error(`reg-viz.html did not contain a window.__reg__ payload.`);return JSON.parse(t[1])}function ya(e){return[...xa(e,`failedItems`).map(t=>ba(e,t,`changed`)),...xa(e,`newItems`).map(t=>ba(e,t,`new`)),...xa(e,`deletedItems`).map(t=>ba(e,t,`deleted`)),...xa(e,`passedItems`).map(t=>ba(e,t,`passed`))]}function ba(e,t,n){let r=t.encoded||t.raw,i=`${n}-${r}`.replace(/[=?&]/g,`-`),a=t.raw||r,o=Sa(t.review||t.visualMetadata||t.metadata);return{actual:Na(e.actualDir,r),diff:Na(e.diffDir,Pa(e,r)),encoded:r,expected:Na(e.expectedDir,r),id:i,raw:a,review:o,variant:n}}function xa(e,t){return Array.isArray(e?.[t])?e[t]:[]}function Sa(e){if(!e||typeof e!=`object`)return null;let t=Wa(e.testTitlePath);return{description:Ua(e.description),domain:Ua(e.domain),expected:Ua(e.expected),focus:Wa(e.focus),kind:Ua(e.kind),sourceFile:Ua(e.sourceFile),storyId:Ua(e.storyId),storyName:Ua(e.storyName),storyTitle:Ua(e.storyTitle),subtitle:Ua(e.subtitle)||(t.length?t.join(` > `):``)||Ua(e.sourceFile),tags:Wa(e.tags),testTitle:Ua(e.testTitle),testTitlePath:t,title:Ua(e.title)}}function Ca(e,t){return wa(e).find(e=>e.kind===t)||wa(e)[0]}function wa(e){return[e.actual&&e.variant!==`deleted`?{kind:`current`,label:`Current image`,url:e.actual}:null,e.expected&&e.variant!==`new`?{kind:`baseline`,label:`Baseline image`,url:e.expected}:null,e.diff&&e.variant===`changed`?{kind:`diff`,label:`Diff image`,url:e.diff}:null].filter(Boolean)}async function Ta({context:e,token:t}){let n=[];for(let r=1;r<=30;r+=1){let i=await Ea(`/repos/${e.repository}/pulls/${e.prNumber}/files?per_page=100&page=${r}`,{context:e,token:t});if(!Array.isArray(i)||i.length===0||(n.push(...i),i.length<100))break}return n}async function Ea(e,{body:t,context:n,method:r=`GET`,token:i}){let a=i.trim();if(!a)throw Error(`GitHub token required.`);let o=await fetch(`https://api.github.com${e}`,{body:t?JSON.stringify(t):void 0,headers:{accept:`application/vnd.github+json`,authorization:`Bearer ${a}`,...t?{"content-type":`application/json`}:{},"x-github-api-version":`2022-11-28`},method:r});if(!o.ok){let e=o.headers.get(`retry-after`),t=``;try{t=(await o.json()).message||``}catch{t=o.statusText}let r=e?` Retry after ${e}s.`:``;throw Error(`GitHub API ${o.status} for PR #${n.prNumber}: ${t}${r}`)}return o.status===204?null:o.json()}function Da(e){try{let t=JSON.parse(localStorage.getItem(e)||`[]`);return Array.isArray(t)?t.filter(e=>e?.image?.valid!==!1):[]}catch{return[]}}function Oa(e,t){let n=e.findIndex(e=>e.id===t.id);return n<0?[...e,t]:e.map((e,r)=>r===n?t:e)}function ka(e){let t=new URL(`./index.html`,window.location.href);return t.searchParams.set(`id`,e.id),t.href}function Aa(e){return ja(e.review?.sourceFile||e.review?.subtitle||``)}function ja(e){let t=String(e||``).split(` > `)[0].trim();if(!t)return null;let n=t.match(/^(.+?):(\d+)(?::\d+)?$/),r=(n?n[1]:t).replace(/^\/+/,``);return!r||/\s/.test(r)?null:{line:n?Number(n[2]):null,path:r}}function Ma(e,t){if(!t?.path||!e.repository)return e.prUrl||``;let n=t.line?`#L${t.line}`:``;return`https://github.com/${e.repository}/blob/${e.headSha}/${t.path}${n}`}function Na(e,t){let n=`${String(e||``).replace(/\/$/,``)}/`;return new URL(String(t||``).replace(/^\//,``),new URL(n,window.location.href)).href}function Pa(e,t){let n=String(e.diffImageExtention||e.diffImageExtension||`webp`).replace(/^\./,``),r=t.lastIndexOf(`/`),i=r>=0?t.slice(0,r+1):``,a=r>=0?t.slice(r+1):t,o=a.lastIndexOf(`.`);return`${i}${o>=0?a.slice(0,o):a}.${n}`}function Fa(e){return e.review?.title||La(e.raw)}function Ia(e){return e.review?.subtitle||e.review?.sourceFile||e.raw}function La(e){return(String(e||``).split(`/`).pop()||e).replace(/\.[^.]+$/,``).replace(/([a-z0-9])([A-Z])/g,`$1 $2`).replace(/([A-Z]+)([A-Z][a-z])/g,`$1 $2`).replace(/[-_.]+/g,` `).replace(/\s+/g,` `).trim().replace(/\b\w/g,e=>e.toUpperCase())||e}function Ra(e){return`visual-review:${e.repository}:${e.prNumber}:github-token`}function za(){let e=localStorage.getItem(ma);return e===`light`||e===`dark`?e:window.matchMedia?.(`(prefers-color-scheme: dark)`).matches?`dark`:`light`}function Ba(e){document.documentElement.dataset.theme=e,document.documentElement.style.colorScheme=e}function Va(e){let t=e===`dark`?`light`:`dark`;return Ba(t),localStorage.setItem(ma,t),t}function Ha(e){return{changed:`Changed`,deleted:`Deleted`,new:`New`,passed:`Unchanged`}[e]||e}function Ua(e){return typeof e==`string`&&e.length>0?e:``}function Wa(e){return Array.isArray(e)?e.filter(e=>typeof e==`string`&&e.length>0):[]}function Ga(e){return String(e||``).slice(0,7)||`unknown`}function Ka(e){return Number(e).toLocaleString(`en-US`,{maximumFractionDigits:3,useGrouping:!1})}function qa(e){let t=Number(e);return Number.isFinite(t)?`${Math.max(0,Math.min(100,t))}%`:`0%`}function Ja(){if(Za()){Xa();return}Ya()}function Ya(e=0){if(e===0&&document.dispatchEvent(new KeyboardEvent(`keydown`,{bubbles:!0,cancelable:!0,code:`KeyF`,ctrlKey:!0,key:`f`,shiftKey:!0})),e<12){window.setTimeout(()=>{if(document.getElementById(`feedback-cursor-styles`))return;let t=document.querySelector(`[title="Start feedback mode"]`);if(t&&typeof t.click==`function`){t.click();return}Ya(e+1)},e===0?100:50);return}}function Xa(e=0){Za()&&(document.dispatchEvent(new KeyboardEvent(`keydown`,{bubbles:!0,cancelable:!0,code:`KeyF`,ctrlKey:!0,key:`f`,shiftKey:!0})),e<5&&window.setTimeout(()=>Xa(e+1),100))}function Za(){if(document.getElementById(`feedback-cursor-styles`))return!0;let e=document.querySelector(`[data-agentation-toolbar]`),t=document.querySelector(`[title="Start feedback mode"]`);return!!(e&&!t)}function Qa(e){e.stopPropagation()}function $a(e){if(!e||e.nodeType!==1)return!1;let t=e,n=t.tagName;return n===`INPUT`||n===`TEXTAREA`||n===`SELECT`||t.isContentEditable||!!t.closest?.(`[contenteditable="true"]`)}function eo(){if(typeof window>`u`||window.__visualReviewImageBoundsGuardInstalled)return;window.__visualReviewImageBoundsGuardInstalled=!0;let e=e=>{if(!document.getElementById(`feedback-cursor-styles`)||e.defaultPrevented||to(e))return;let t=document.querySelector(`[data-annotation-image]`);if(!t)return;let n=t.getBoundingClientRect();e.clientX>=n.left&&e.clientX<=n.right&&e.clientY>=n.top&&e.clientY<=n.bottom||(e.preventDefault(),e.stopPropagation(),typeof e.stopImmediatePropagation==`function`&&e.stopImmediatePropagation(),window.dispatchEvent(new CustomEvent(`visual-review-annotation-blocked`,{detail:{reason:`outside-image`}})))};document.addEventListener(`pointerdown`,e,!0),document.addEventListener(`mousedown`,e,!0),document.addEventListener(`click`,e,!0)}function to(e){return Z(e)||no(e).some(e=>!e||e.nodeType!==1||typeof e.matches!=`function`?!1:e.matches(`[data-agentation-toolbar], [data-agentation-toolbar] *, [data-annotation-popup], [data-annotation-popup] *, [data-annotation-marker], [data-annotation-marker] *`))}function Z(e){return no(e).some(e=>!e||e.nodeType!==1||typeof e.matches!=`function`?!1:e.matches(`[data-annotation-control], [data-annotation-control] *`))}function no(e){if(typeof e.composedPath==`function`)return e.composedPath();let t=[],n=e.target;for(;n;)t.push(n),n=n.parentNode;return t}function ro(){let[e,t]=(0,b.useState)(()=>window.matchMedia(`(min-width: 781px)`).matches);return(0,b.useEffect)(()=>{let e=window.matchMedia(`(min-width: 781px)`),n=()=>t(e.matches);return e.addEventListener(`change`,n),()=>e.removeEventListener(`change`,n)},[]),e}